...
import rumidarwaza from "../images/rumidarwaza.jpg"
import { 
...
// --- PRAYAGRAJ TO LUCKNOW PACKAGE DATA ---
const packageData = {
  title: "Heritage Path: Prayagraj to Lucknow Tour",
  rating: 4.8,
  reviews: 420,
  ...
  itinerary: [
    {
      ...
      image: prayagraj,
      description: "Arrival at Prayagraj Airport/Railway Station. Transfer to hotel. In the afternoon, visit the holy Triveni Sangam, Anand Bhawan, and the reclining Hanuman Temple. Explore the local culture of the Sangam city. Overnight stay in Prayagraj."
    },
    {
      day: 2,
      title: "Drive to Lucknow & Evening Leisure",
      image: Lucknow,
      description: "After breakfast, drive to the 'City of Nawabs', Lucknow. Upon arrival, check-in to your hotel. In the evening, visit Hazratganj for some leisure shopping or enjoy the world-famous Tunday Kababi. Overnight stay in Lucknow."
    },
    {
      day: 3,
      title: "Lucknow Local Sightseeing & Departure",
      image: rumidarwaza,
      description: "Explore the architectural marvels: Bara Imambara, Chhota Imambara, Rumi Darwaza, and the British Residency. After a heritage local tour, you will be transferred to Lucknow Airport or Railway Station for your return journey."
    }
  ],
  highlights: [
    "3 Days heritage tour connecting the spiritual vibes of Prayagraj with the regal Nawabi culture.",
    "Holy dip at Triveni Sangam and guided tour of Bara Imambara.",
    "Explore the architectural wonders of the British Residency.",
    "Comfortable private AC vehicle for the entire interstate journey.",
    "Read More"
  ],
  transfer: [
    "Pickup from Prayagraj Airport/Railway Station.",
    "Inter-city transfer (Prayagraj to Lucknow) in private AC vehicle.",
  ...
  sightseeing: [
    ...
    "Lucknow: Bara Imambara, Rumi Darwaza, British Residency, Hazratganj."
  ],
  accommodation: [
    "Prayagraj: 1 Night in a 3-star or 4-star category hotel.",
    "Lucknow: 1 Night in a Heritage or Deluxe category hotel."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "1 bottle of packaged drinking water per person per day.",
    "Welcome traditional refreshments provided in Lucknow."
  ],
  inclusionExclusions: {
    inclusions: [
      ...
      "Professional local guide for Lucknow heritage sites."
    ],
    exclusions: [
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> Heritage Path</div>
              ...
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                ...
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Nawabi Gate" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>
            ...
            {activeMainTab === 'calculate price' && (
              <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div><label className="block text-sm font-semibold text-gray-700 mb-2">Departure City <span className="text-red-500">*</span></label><select className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm text-gray-700 outline-none focus:border-red-400 bg-white"><option>Prayagraj</option><option>Lucknow</option><option>Delhi</option></select></div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  ...
                  <p className="text-[11px] text-gray-500 ml-6">Upto 4K off on Heritage Tours*</p>
                </div>
              </div>
            </div>
          </div>
...
export default PrayagrajLucknowTour;