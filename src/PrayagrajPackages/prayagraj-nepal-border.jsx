...
// --- PRAYAGRAJ TO NEPAL BORDER PACKAGE DATA ---
const packageData = {
  title: "International Link: Prayagraj to Nepal Border",
  rating: 4.6,
  reviews: 580,
  ...
  images: [
    lumbin, // Lumbini / Nepal Border
    prayagraj, // Prayagraj Sangam
    RamMandir  // Ayodhya Darshan
  ],
  itinerary: [
    {
      day: 1,
      title: "Arrival in Prayagraj & Sangam Visit",
      image: prayagraj,
      description: "Arrive at Prayagraj. Transfer to hotel. Afternoon visit to Triveni Sangam for a holy dip, Anand Bhawan, and Hanuman Temple. Overnight stay in Prayagraj."
    },
    {
      day: 2,
      title: "Drive to Ayodhya & Evening Aarti",
      image: GangaAarti,
      description: "After breakfast, check out and drive to Ayodhya. Upon arrival, check-in to your hotel. Visit the Saryu River Ghats for the evening Aarti. Overnight stay in Ayodhya."
    },
    {
      day: 3,
      title: "Ayodhya Darshan & Drive to Gorakhpur",
      image:  RamMandir,
      description: "Visit Shri Ram Janmabhoomi, Hanuman Garhi, and Kanak Bhawan. Post Darshan, proceed to Gorakhpur. Visit the Gorakhnath Temple. Overnight stay in Gorakhpur."
    },
    {
      day: 4,
      title: "Sonauli Border Crossing & Lumbini",
      image: lumbin,
      description: "Proceed to Sonauli (Indo-Nepal Border). Complete immigration and enter Nepal. Visit Lumbini, the birthplace of Lord Buddha, including Maya Devi Temple. Overnight stay near Border/Lumbini."
    },
    {
      day: 5,
      title: "Local Exploration & Departure",
      image: Gorakhpurrailwaystation,
      description: "Morning visit to international monasteries. Later, transfer back to Gorakhpur Railway Station or Airport for departure."
    }
  ],
  highlights: [
    "5 Days cross-border link tour connecting major spiritual hubs of UP with Nepal Gateway.",
    "Hassle-free border crossing assistance at Sonauli.",
    "Guided spiritual tour of Lumbini UNESCO World Heritage site.",
    "Comfortable private AC vehicle for the entire interstate and border route.",
    "Read More"
  ],
  transfer: [
    "Pickup from Prayagraj Airport/Railway Station.",
    "International border transit assistance at Sonauli Gateway.",
    "All local and inter-city transfers by private AC vehicle.",
    "Toll taxes, border permit fees, and driver allowances included."
  ],
  sightseeing: [
    "Prayagraj: Triveni Sangam, Anand Bhawan.",
    "Ayodhya: Ram Janmabhoomi, Hanuman Garhi, Saryu Ghat.",
    "Nepal: Lumbini Garden, Maya Devi Temple, Monastic Zone."
  ],
  accommodation: [
    "Prayagraj: 1 Night in a 3-star category hotel.",
    "Ayodhya: 1 Night in a Premium Boutique Hotel.",
    "Gorakhpur: 1 Night in a Deluxe hotel.",
    "Border/Lumbini: 1 Night in a Deluxe category hotel."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "1 bottle of packaged drinking water per person per day.",
    "Traditional Satvik refreshments provided during the transit days."
  ],
  inclusionExclusions: {
    inclusions: [
      "Accommodation on twin-sharing basis.",
      "Breakfast and Dinner as specified in the plan.",
      "Indo-Nepal vehicle permits and international taxes.",
      "Professional border assistance."
    ],
    exclusions: [
      "Airfare or Train tickets.",
      "Monument entrance fees.",
      "Nepal Visa fees (for non-Indian nationals).",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="International Border Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              ...
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Nepal" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden"><img src={packageData.images[1]} alt="Prayagraj" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Ayodhya" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>
            ...
            {activeMainTab === 'calculate price' && (
              <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div><label className="block text-sm font-semibold text-gray-700 mb-2">Departure City <span className="text-red-500">*</span></label><select className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm text-gray-700 outline-none focus:border-red-400 bg-white"><option>Prayagraj</option><option>Varanasi</option><option>Delhi</option></select></div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +500</strong><br/>Holiday Reward points</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  ...
                  <p className="text-[11px] text-gray-500 ml-6">Upto 6K off on Border Link Tours*</p>
                </div>
              </div>
            </div>
          </div>
...
export default PrayagrajNepalTour;