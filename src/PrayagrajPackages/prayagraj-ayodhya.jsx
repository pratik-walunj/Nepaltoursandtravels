...
import RamMandirAyodhya from "../images/Ram-Mandir-Ayodhya-Tour.jpg"
...
// --- PRAYAGRAJ TO AYODHYA PACKAGE DATA ---
const packageData = {
  title: "Temple Circuit: Prayagraj to Ayodhya Tour",
  rating: 5.0,
  reviews: 890,
  ...
  images: [
    RamMandirAyodhya, // Ayodhya Ram Mandir
  ...
  itinerary: [
    {
      ...
      image: prayagraj,
      description: "Arrival at Prayagraj Airport/Railway Station. Transfer to hotel. Afternoon visit to Triveni Sangam for a holy dip, Anand Bhawan, and the Reclining Hanuman Temple. In the evening, explore the local spiritual vibe of the city. Overnight stay in Prayagraj."
    },
    {
      day: 2,
      title: "Drive to Ayodhya & Saryu Aarti",
      image: sarayughat,
      description: "After breakfast, check out and drive to the holy city of Ayodhya. Upon arrival, check-in to your hotel. In the evening, proceed to the banks of the Saryu River for the divine Aarti. Overnight stay in Ayodhya."
    },
    {
      day: 3,
      title: "Ram Janmabhoomi Darshan & Departure",
      image: RamMandirAyodhya,
      description: "Visit the grand Shri Ram Janmabhoomi Temple, Hanuman Garhi, and Kanak Bhawan. After a spiritual local tour and lunch, transfer to Ayodhya Railway Station or Airport for your return journey."
    }
  ],
  highlights: [
    "3 Days spiritual circuit linking the holy confluence (Sangam) with the birthplace of Lord Ram.",
    "Holy dip at Triveni Sangam and VIP Darshan at Shri Ram Janmabhoomi.",
    "Mesmerizing evening Aarti experience at the Saryu River.",
    "Comfortable private AC vehicle for all transfers and sightseeing.",
    "Read More"
  ],
  transfer: [
    "Pickup from Prayagraj Airport/Railway Station.",
    "Inter-city transfer from Prayagraj to Ayodhya in private AC vehicle.",
    "Drop-off at Ayodhya Airport/Railway Station.",
    "All toll, parking, and driver allowances included."
  ],
  sightseeing: [
    "Prayagraj: Triveni Sangam, Anand Bhawan, Reclining Hanuman Temple.",
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "Meals as specified in the plan (Breakfast & Dinner).",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Prayagraj Ayodhya Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> Temple Circuit</div>
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Ayodhya" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                ...
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Darshan" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> TEMPLE26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 5K off on Temple Circuit Tours*</p>
                </div>
              </div>
            </div>
          </div>
...
export default PrayagrajAyodhyaTour;