...
// --- PRAYAGRAJ TO KASHI PACKAGE DATA ---
const packageData = {
  title: "Spiritual Circuit: Prayagraj to Kashi Tour",
  rating: 4.9,
  reviews: 920,
  ...
  images: [
    ...
    Kashi, // Kashi Vishwanath area
    GangaAarti  // Ganga Aarti
  ],
  itinerary: [
    {
      day: 1,
      title: "Arrival in Prayagraj & Holy Sangam",
      image: prayagraj,
      description: "Arrival at Prayagraj. Transfer to hotel. Afternoon visit to the sacred Triveni Sangam for a holy dip. Visit Anand Bhawan, the reclining Hanuman Temple, and the Allahabad Fort. Evening at leisure. Overnight stay in Prayagraj."
    },
    {
      day: 2,
      title: "Drive to Kashi & Evening Ganga Aarti",
      image: GangaAarti,
      description: "After breakfast, drive to Varanasi (Kashi). Upon arrival, check-in to your hotel. In the evening, witness the world-famous Ganga Aarti at Dashashwamedh Ghat from a private boat. Experience the spiritual vibe of the ancient city. Overnight stay in Varanasi."
    },
    {
      day: 3,
      title: "Kashi Darshan & Departure",
      image: Kashi,
      description: "Early morning visit to Kashi Vishwanath Temple, Annapurna Temple, and Kaal Bhairav. After breakfast, explore Sarnath (optional) or local silk weaving centers. Afternoon transfer to Varanasi Airport or Railway Station for departure."
    }
  ],
  highlights: [
    "3 Days spiritual link between the Holy Confluence and the Oldest Living City.",
    "Holy dip at Triveni Sangam and VIP Darshan at Kashi Vishwanath.",
    "Mesmerizing Ganga Aarti experience by boat in Varanasi.",
    "Private AC vehicle for a comfortable inter-city journey.",
    "Read More"
  ],
  transfer: [
    "Pickup from Prayagraj Airport/Railway Station.",
    "Inter-city transfer (Prayagraj to Varanasi) in private AC vehicle.",
  ...
  sightseeing: [
    ...
    "Varanasi: Kashi Vishwanath, Ganga Aarti, Sarnath, Banaras Hindu University."
  ],
  accommodation: [
    "Prayagraj: 1 Night in a 3-star or 4-star category hotel.",
    "Varanasi: 1 Night in a Deluxe category hotel."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "1 bottle of packaged drinking water per person per day during transit.",
    "Welcome traditional refreshment upon arrival in Prayagraj."
  ],
  inclusionExclusions: {
    inclusions: [
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Kashi Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> Spiritual Circuit</div>
              ...
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                ...
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Ganga Aarti" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> KASHI26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 4K off on Kashi Connect Tours*</p>
                </div>
              </div>
            </div>
          </div>
...
export default PrayagrajKashiTour;