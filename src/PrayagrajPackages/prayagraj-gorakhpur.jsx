...
// --- PRAYAGRAJ TO GORAKHPUR PACKAGE DATA ---
const packageData = {
  title: "Heritage Pathway: Prayagraj to Gorakhpur Tour",
  rating: 4.7,
  reviews: 680,
  ...
  images: [
    Gorakhpur, // Gorakhpur Temple Style
  ...
  itinerary: [
    {
      day: 1,
      title: "Arrival in Prayagraj & Triveni Sangam",
      image: prayagraj,
      description: "Arrival at Prayagraj. Transfer to hotel. Visit the holy Triveni Sangam for a sacred dip, Anand Bhawan, and the Reclining Hanuman Temple. Experience the spiritual energy of the Sangam city. Overnight stay in Prayagraj."
    },
    {
      day: 2,
      title: "Drive to Ayodhya & Evening Aarti",
      image: GangaAarti,
      description: "After breakfast, check out and drive to Ayodhya. Upon arrival, check-in to your hotel. Visit the Saryu River Ghats for the evening Aarti. Explore the local markets of the old city. Overnight stay in Ayodhya."
    },
    {
      day: 3,
      title: "Ayodhya Darshan & Drive to Gorakhpur",
      image: HanumanGarhi,
      description: "Visit Shri Ram Janmabhoomi, Hanuman Garhi, and Kanak Bhawan. After Darshan, drive to Gorakhpur. Upon arrival, check-in to your hotel. Visit the Gorakhnath Temple for the evening prayers. Overnight stay in Gorakhpur."
    },
    {
      day: 4,
      title: "Gorakhpur Sightseeing & Departure",
      image: Gorakhpurrailwaystation,
      description: "After breakfast, visit the historic Gita Press and the Rail Museum. If time permits, visit Maghar. Later, transfer to Gorakhpur Railway Station or Airport for your return journey."
    }
  ],
  highlights: [
    "4 Days heritage circuit covering Prayagraj, Ayodhya, and Gorakhpur.",
    "Holy dip at Triveni Sangam and VIP Darshan at Ram Janmabhoomi.",
    "Guided visit to the world-famous Gita Press and Gorakhnath Temple.",
    "Private AC vehicle for all inter-city and local transfers.",
    "Read More"
  ],
  transfer: [
    "Pickup from Prayagraj Airport/Railway Station.",
    "Inter-city transfers (Prayagraj-Ayodhya-Gorakhpur) in private AC vehicle.",
    "Drop-off at Gorakhpur Airport/Railway Station.",
    "All toll, parking, and driver allowances included."
  ],
  sightseeing: [
    "Prayagraj: Triveni Sangam, Anand Bhawan, Hanuman Temple.",
    "Ayodhya: Ram Janmabhoomi, Hanuman Garhi, Kanak Bhawan.",
    "Gorakhpur: Gorakhnath Temple, Gita Press, Maghar."
  ],
  accommodation: [
    "Prayagraj: 1 Night in a 3-star category hotel.",
    "Ayodhya: 1 Night in a Premium Boutique Hotel.",
    "Gorakhpur: 1 Night in a Deluxe category hotel."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "1 bottle of packaged drinking water per person per day.",
    "Traditional vegetarian refreshments during transit."
  ],
  inclusionExclusions: {
    inclusions: [
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Sangam to Heritage" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> Heritage Circuit</div>
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Gorakhpur" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden"><img src={packageData.images[1]} alt="Sangam" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
            ...
            {activeMainTab === 'calculate price' && (
              <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div><label className="block text-sm font-semibold text-gray-700 mb-2">Departure City <span className="text-red-500">*</span></label><select className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm text-gray-700 outline-none focus:border-red-400 bg-white"><option>Prayagraj</option><option>Ayodhya</option><option>Delhi</option></select></div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  ...
                  <p className="text-[11px] text-gray-500 ml-6">Upto 4K off on Heritage Circuit Tours*</p>
                </div>
              </div>
            </div>
          </div>
...
export default PrayagrajGorakhpurTour;