...
// --- GORAKHPUR TO AYODHYA SCHOOL TRIP MOCK DATA ---
const packageData = {
  title: "Divine Heritage: Gorakhpur to Ayodhya School Trip",
  rating: 4.9,
  reviews: 450,
  ...
  images: [
    ...
    AyodhyaGhats , // River Ghats/Aarti
    hanumanGarhi  // Cultural Learning
  ],
  itinerary: [
    {
      day: 1,
      title: "School Departure, Hanuman Garhi & Evening Saryu Aarti",
      image: hanumanGarhi,
      description: "Students and teachers will assemble at the school premises in Gorakhpur early in the morning. Board our safe, sanitized deluxe AC bus for a comfortable educational drive to Ayodhya (approx. 3 hours). Upon arrival, check into a secure, student-friendly hotel and enjoy a nutritious lunch. In the afternoon, students will visit the historic Hanuman Garhi and Kanak Bhawan, learning about ancient Indian architecture and mythology. In the evening, the group will head to the banks of the Saryu River at Naya Ghat to witness the mesmerizing Aarti, teaching students about river reverence in Indian culture. Dinner and overnight stay at the hotel."
    },
    {
      day: 2,
      title: "Ram Janmabhoomi Educational Tour & Safe Return",
      image: AyodhyaGhats ,
      description: "After a healthy and hearty breakfast, the group will proceed to the magnificent Ram Janmabhoomi Temple complex. An educational guide will walk the students through the historical timeline, cultural importance, and architectural grandeur of the site. Later, visit Dashrath Mahal and Nageshwarnath Temple. Following an engaging learning session and a fulfilling lunch, the group will board the bus for a safe return journey. Students will be securely dropped off at the school campus in Gorakhpur by the late afternoon."
    }
  ],
  highlights: [
    "Educational guided tour of the historic Ram Janmabhoomi complex.",
    "Safe, monitored, and fully escorted group travel specially designed for schools.",
    "Witness the cultural grandeur of the evening Saryu River Aarti.",
    "Learn about ancient Indian architecture at Kanak Bhawan and Hanuman Garhi.",
    "Nutritious, hygienic, and student-friendly pure vegetarian meals provided."
  ],
  transfer: [
    ...
    "Comfortable inter-city transit via well-maintained highways.",
    "All toll taxes, parking fees, and driver allowances are included."
  ],
  sightseeing: [
    "Historical Sites: Ram Janmabhoomi Temple, Dashrath Mahal.",
    "Cultural Immersion: Hanuman Garhi, Kanak Bhawan.",
    "Nature & Tradition: Saryu River Ghats and Evening Aarti viewing."
  ],
  accommodation: [
    "Ayodhya: 1 Night in a safe, secure, and student-friendly premium hotel.",
  ...
  meals: [
    ...
    "Packaged drinking water provided during the journey and sightseeing."
  ],
  inclusionExclusions: {
    inclusions: [
      "Safe accommodation in Ayodhya (Student multi-sharing).",
    ...
    exclusions: [
      ...
      "Special VIP Darshan tickets or individual Puja offerings.",
...
const GorakhpurToAyodhyaSchool = () => {
  ...
  const handleCalculatePrice = () => {
    ...
    if (!selectedVehicle) {
      setFormError("Please select a Vehicle option.");
      return;
    }
    ...
    if (!agreedToTerms) {
      setFormError("Please accept the School Trip Policy & Terms.");
      return;
    }
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Gorakhpur to Ayodhya School Trip" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              ...
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Temple Architecture" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                ...
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Cultural Learning" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
...
export default GorakhpurToAyodhyaSchool;