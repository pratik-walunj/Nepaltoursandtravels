...
// --- GORAKHPUR TO KUSHINAGAR SCHOOL TRIP MOCK DATA ---
const packageData = {
  title: "Educational Pilgrimage: Gorakhpur to Kushinagar School Trip",
  rating: 4.8,
  reviews: 415,
  ...
  itinerary: [
    {
      day: 1,
      title: "Departure from School & Mahaparinirvana Tour",
      image: "https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Students and teachers will gather at the school premises in Gorakhpur in the morning. Board our safe and comfortable deluxe AC bus and embark on a short, 1.5-hour educational drive to Kushinagar. Upon arrival, check into a secure, student-friendly hotel and have a nutritious lunch. In the afternoon, students will visit the Mahaparinirvana Temple to see the 6.1-meter-long Reclining Buddha statue. An educational guide will narrate the history of Lord Buddha's final days. Next, visit the Ramabhar Stupa, the historic cremation site. Evening group activities and dinner at the hotel."
    },
    {
      day: 2,
      title: "Global Architecture Tour & Safe Return to Gorakhpur",
      image: gorakhpur,
      description: "After a healthy breakfast, students will go on a cultural exploration of the beautifully maintained international monasteries in Kushinagar. Visit the Wat Thai Temple, the Indo-Japan-Sri Lanka Temple, and the Matha Kuar Shrine. This session focuses on understanding global Buddhist cultures, art, and architecture. After an engaging learning session and a hearty lunch, the group will board the bus for a safe return journey. Students will be safely dropped off at the school campus in Gorakhpur by the afternoon."
    }
  ],
  highlights: [
    "Educational guided tour of the Mahaparinirvana Temple and Reclining Buddha.",
    "Safe, monitored, and fully escorted group travel specially designed for schools.",
    "Learn about global architecture at the Thai and Japanese Monasteries.",
    "Short, fatigue-free travel distance from Gorakhpur.",
  ...
  transfer: [
    ...
    "Short and comfortable inter-city transit.",
    "All toll taxes, parking fees, and driver allowances are included."
  ],
  sightseeing: [
    "Historical Sites: Mahaparinirvana Temple, Ramabhar Stupa, Matha Kuar Shrine.",
    "Monastic Zone: Wat Thai Temple, Indo-Japan-Sri Lanka Temple.",
    "Educational storytelling by experienced local history guides."
  ],
  accommodation: [
    "Kushinagar: 1 Night in a safe, secure, and student-friendly premium hotel/lodge.",
  ...
  inclusionExclusions: {
    inclusions: [
      "Safe accommodation in Kushinagar (Student multi-sharing).",
    ...
    exclusions: [
      ...
      "Monument and Museum entrance fees (if applicable for schools).",
...
const GorakhpurToKushinagarSchool = () => {
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Gorakhpur to Kushinagar School Trip" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              ...
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Mahaparinirvana Temple" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
...
export default GorakhpurToKushinagarSchool;