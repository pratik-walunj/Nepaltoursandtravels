...
import balmikbanner from "../images/balmikbanner.png"
// --- GORAKHPUR TO BALMIKI NAGAR SCHOOL TRIP MOCK DATA ---
const packageData = {
  title: "Eco & Wildlife Expedition: Gorakhpur to Balmiki Nagar School Trip",
  rating: 4.8,
  reviews: 245,
  ...
  images: [
    ...
    "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", // River/Nature
    balmikbanner  // Wildlife/Deer
  ],
  itinerary: [
    {
      day: 1,
      title: "Departure, Nature Walk & Gandak Barrage Visit",
      image: "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Students and teachers will assemble at the school premises in Gorakhpur early in the morning. Board our safe deluxe AC bus and embark on a scenic drive to Balmiki Nagar (Valmiki Tiger Reserve) in Bihar (approx. 3-4 hours). Upon arrival, check into a secure eco-resort or hotel. After a nutritious lunch, an educational guide will lead the students on a safe nature walk to understand local flora. In the evening, visit the impressive Gandak River Barrage situated at the Indo-Nepal border, learning about river ecosystems and irrigation. Return to the hotel for an interactive eco-awareness session and dinner."
    },
    {
      day: 2,
      title: "Morning Jungle Safari, Wildlife Education & Return",
      image: "https://images.unsplash.com/photo-1549366021-9f761d450615?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Wake up early for the highlight of the trip—an exciting Jungle Safari inside the Valmiki National Park! Safely seated in authorized safari vehicles, students will learn about the tiger reserve's biodiversity, spotting deer, wild boars, exotic birds, and learning about tiger conservation efforts. Return to the hotel for a heavy and healthy breakfast. After packing up, the group will board the bus for a safe return journey to Gorakhpur, dropping the students back at the school campus by late afternoon."
    }
  ],
  highlights: [
    "Thrilling and educational Jungle Safari in Valmiki National Park.",
    "Visit the massive Gandak River Barrage at the Indo-Nepal border.",
    "Learn about wildlife conservation, flora, and river ecosystems.",
    "Safe, monitored, and fully escorted group travel designed for schools.",
    "Nutritious, hygienic, and student-friendly meals provided."
  ],
  transfer: [
    "Pick-up and drop-off directly from the School Campus in Gorakhpur.",
    "Travel by safe, sanitized, and GPS-enabled Deluxe AC Coaches.",
    "Authorized safari vehicles for the Valmiki National Park jungle tour.",
    "All toll taxes, parking fees, and driver allowances are included."
  ],
  sightseeing: [
    "Valmiki Tiger Reserve: Morning Jungle Safari, Eco-trail walk.",
    "Gandak Barrage: Sightseeing at the Indo-Nepal river border.",
    "Educational sessions by local wildlife guides."
  ],
  accommodation: [
    "Balmiki Nagar: 1 Night in a safe, secure, and eco-friendly premium hotel/lodge.",
  ...
  meals: [
    ...
    "Packaged drinking water provided during the journey and safari."
  ],
  inclusionExclusions: {
    inclusions: [
      "Safe accommodation in Balmiki Nagar (Student multi-sharing).",
      "All meals (Breakfast, Lunch, Dinner) during the trip.",
      "Round-trip transportation by Deluxe AC School/Tourist Bus.",
      "Jungle Safari tickets and authorized forest guide fees.",
      "Dedicated Tour Manager & First-Aid kit on board."
    ],
    exclusions: [
      "Personal expenses (shopping, telephone, snacks outside meals).",
      "Camera fees inside the National Park (if applicable).",
...
const GorakhpurToBalmikiNagarSchool = () => {
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Gorakhpur to Balmiki Nagar School Trip" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md">
                <Users size={14} className="mr-1" /> Wildlife & Eco Tour
              </div>
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Valmiki National Park" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Gandak River" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Wildlife Education" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              ...
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                ...
                <span className="text-xs font-semibold text-gray-700">Safari Tour</span>
              </div>
              <div className="flex flex-col items-center justify-center min-w-[80px]">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> SAFARI10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on groups larger than 40*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> ECOFREE</div>
...
export default GorakhpurToBalmikiNagarSchool;