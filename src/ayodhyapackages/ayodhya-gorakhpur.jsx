...
import gorakhpurbanner from "../images/gorakhpurbanner.jpg"
import RamMandir from "../images/Ram-Mandir-Ayodhya-Tour.jpg"
import Maghar from "../images/Maghar.webp"
import { 
...
// --- AYODHYA GORAKHPUR 2N/3D PACKAGE DATA ---
const packageData = {
  title: "Heritage Route: Ayodhya to Gorakhpur",
  rating: 4.7,
  reviews: 415,
  duration: "2 Nights 3 Days",
  route: "Ayodhya (1N) → Gorakhpur (1N) → Maghar → Gita Press",
  originalPrice: "....",
  basePriceAdult: ".....",
  ...
  itinerary: [
    {
      ...
      description: "Arrival at Ayodhya and transfer to hotel. Visit the grand Shri Ram Janmabhoomi, Hanuman Garhi, and Kanak Bhawan. In the evening, witness the soul-stirring Saryu River Aarti. Overnight stay in Ayodhya."
    },
    {
      day: 2,
      title: "Ayodhya to Gorakhpur via Maghar",
      image: Maghar,
      description: "After breakfast, check out and drive to Gorakhpur. En route, visit Maghar, the final resting place of Saint Kabir. Upon arrival in Gorakhpur, check into your hotel. Evening visit to the vibrant local markets. Overnight stay in Gorakhpur."
    },
    {
      day: 3,
      title: "Gorakhnath Temple, Gita Press & Departure",
      image: VisitGorakhnathTemple,
      description: "Early morning visit to Gorakhnath Temple for Darshan. Later, explore Gita Press, the world's largest publisher of Hindu religious texts. After lunch, visit the Gorakhpur Imambara before being transferred to the Airport or Railway Station for departure."
    }
  ],
  highlights: [
    "Extended 3-day spiritual circuit connecting Ayodhya and Gorakhpur.",
    "Detailed visit to Gita Press Museum and Art Gallery.",
    "VIP Darshan at Gorakhnath Temple and Ram Janmabhoomi.",
    "Visit to the historical and spiritual site of Maghar (Kabir Chaura).",
    "Read More"
  ],
  transfer: [
    "Pickup from Ayodhya Railway Station/Airport.",
    "Inter-city transfers (Ayodhya-Maghar-Gorakhpur) by private AC vehicle.",
    "Drop-off at Gorakhpur Airport/Station.",
    "Toll taxes, parking fees, and driver allowances included."
  ],
  sightseeing: [
    "Ayodhya: Ram Mandir, Hanuman Garhi, Kanak Bhawan, Saryu Ghat.",
    "Maghar: Saint Kabir Nirvana Sthal.",
    "Gorakhpur: Gorakhnath Temple, Gita Press, Planetarium, Imambara."
  ],
  accommodation: [
    "Ayodhya: 1 Night in a Deluxe/Premium Hotel.",
    "Gorakhpur: 1 Night in a 3-star or 4-star category hotel."
  ],
  meals: [
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Ayodhya Gorakhpur Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> Heritage Tour</div>
              ...
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                ...
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="River" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> GORAKH26</div>
...
export default AyodhyaGorakhpur;