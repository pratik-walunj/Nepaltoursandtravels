...
import Gorakhnath from "../images/Visit-Gorakhnath-Temple.jpg"
...
// --- AYODHYA NEPAL (SONAULI) PACKAGE DATA ---
const packageData = {
  title: "International Link: Ayodhya to Nepal (Sonauli)",
  rating: 4.8,
  reviews: 640,
  ...
  images: [
    lumbin, // Lumbini Stupa
    RamMandir, // Ram Mandir
    Gorakhnath  // Gorakhpur Temple
  ],
  itinerary: [
    {
      day: 1,
      ...
      image: RamMandir,
      description: "Arrival at Ayodhya. Transfer to hotel. Visit Shri Ram Janmabhoomi, Hanuman Garhi, and Kanak Bhawan. Evening Saryu River Aarti. Overnight stay in Ayodhya."
    },
    {
      day: 2,
      title: "Ayodhya to Gorakhpur Transit",
      image: Gorakhnath,
      description: "After breakfast, drive to Gorakhpur. Visit the famous Gorakhnath Temple and Gita Press. Evening explore local markets. Overnight stay in Gorakhpur."
    },
    {
      day: 3,
      title: "Cross Sonauli Border & Lumbini Visit",
      image: lumbin,
      description: "Early morning drive to Sonauli (Nepal Border). Complete immigration formalities and enter Nepal. Visit Lumbini, the birthplace of Lord Buddha, including Maya Devi Temple and World Peace Stupa. Overnight stay near the border or Lumbini."
    },
    {
      day: 4,
      title: "Local Exploration & Departure",
      image: Gorakhpurrailwaystation,
      description: "Short visit to nearby monasteries. Later, transfer back to Gorakhpur Railway Station or Airport for your return journey."
    }
  ],
  highlights: [
    "Cross-border spiritual journey covering the Ramayana circuit and Buddhist heritage.",
    "Hassle-free border crossing assistance at Sonauli.",
    "Guided visit to the UNESCO World Heritage site of Lumbini.",
    "Comfortable AC transport for the entire interstate and international route.",
    "Read More"
  ],
  transfer: [
    "Pickup from Ayodhya Railway Station/Airport.",
    "Border transit assistance at Sonauli (Indo-Nepal Border).",
    "Private AC vehicle for all transfers and sightseeing.",
    "Toll taxes, border entry fees (Permit), and driver allowances included."
  ],
  sightseeing: [
    "Ayodhya: Ram Janmabhoomi, Hanuman Garhi, Saryu Ghat.",
    "Gorakhpur: Gorakhnath Temple, Maghar (Optional).",
    "Nepal: Lumbini Garden, Maya Devi Temple, Monastic Zone."
  ],
  accommodation: [
    "Ayodhya: 1 Night in a Deluxe Hotel.",
    "Gorakhpur: 1 Night in a 3-star category hotel.",
    "Lumbini/Sonauli: 1 Night in a Standard/Deluxe hotel."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "Traditional Indian/Nepalese meals provided as per plan.",
    "Packaged drinking water provided during transit."
  ],
  inclusionExclusions: {
    inclusions: [
      "Indo-Nepal vehicle permit and taxes.",
    ...
    exclusions: [
      ...
      "Visa fees for non-Indian nationals.",
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Globe size={14} className="mr-1" /> International Tour</div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +550</strong><br/>Holiday Reward points</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> NEPAL2026</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 6K off on International Link Tours*</p>
                </div>
              </div>
            </div>
          </div>
