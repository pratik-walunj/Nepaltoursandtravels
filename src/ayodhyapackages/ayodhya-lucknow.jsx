...
import luknow from "../images/luknow.jpg"
import Lucknow from "../images/lucknowbanner .jpg"
...
// --- AYODHYA LUCKNOW PACKAGE DATA ---
const packageData = {
  title: "City Link: Ayodhya to Lucknow",
  rating: 4.6,
  reviews: 580,
  ...
  images: [
    ...
    HanumanGarhi  // Hanuman Garhi
  ],
  itinerary: [
    {
      day: 1,
      title: "Ayodhya Arrival & Spiritual Darshan",
      image: RamMandir,
      description: "Arrive at Ayodhya. Check-in and proceed to visit the Ram Janmabhoomi Temple, Hanuman Garhi, and Kanak Bhawan. In the evening, explore the Saryu River Ghats and witness the Aarti. Overnight stay in Ayodhya."
    },
    {
      day: 2,
      title: "Drive to Lucknow & Heritage Tour",
      image: Lucknow,
      description: "After breakfast, drive to the 'City of Nawabs', Lucknow. Check-in to your hotel and visit the architectural marvels: Bara Imambara, Chhota Imambara, and the Rumi Darwaza. Explore the local markets for Chikan embroidery. Overnight stay in Lucknow."
    },
    {
      day: 3,
      title: "Lucknow Residency & Departure",
      image: luknow,
      description: "Visit the British Residency and the Ambedkar Memorial Park. After a traditional Awadhi lunch, you will be transferred to the Lucknow Airport or Railway Station for your departure."
    }
  ],
  highlights: [
    "Comprehensive 3-day tour linking the spiritual vibes of Ayodhya with the heritage of Lucknow.",
    "Guided visit to the Bara Imambara and British Residency.",
    "VIP Darshan at Ram Janmabhoomi, Ayodhya.",
    "Delicious Awadhi food experience in Lucknow.",
    "Read More"
  ],
  transfer: [
    "Pickup from Ayodhya Railway Station/Airport.",
    "Inter-city transfers by private AC vehicle.",
    "Local sightseeing in Ayodhya and Lucknow.",
    "All toll, parking, and driver allowances included."
  ],
  sightseeing: [
    "Ayodhya: Ram Janmabhoomi, Hanuman Garhi, Kanak Bhawan, Saryu Ghat.",
    "Lucknow: Bara Imambara, Chhota Imambara, Residency, Ambedkar Park."
  ],
  accommodation: [
    "Ayodhya: 1 Night in a 3-star category hotel.",
    "Lucknow: 1 Night in a 4-star category hotel."
  ],
  meals: [
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "Professional guide for Lucknow monuments."
    ],
    exclusions: [
      "Airfare/Train tickets.",
      "Monument entry fees.",
      "Personal expenses and laundry.",
      "GST as per government norms."
    ]
  }
};
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Ayodhya Lucknow Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> City Link</div>
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Lucknow" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden"><img src={packageData.images[1]} alt="Ayodhya" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Ayodhya Mandir" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>

            {/* Inclusions */}
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              {[{ icon: <BedDouble size={24} />, label: "Hotel", color: "bg-pink-500" }, { icon: <Utensils size={24} />, label: "Meals", color: "bg-orange-500" }, { icon: <Camera size={24} />, label: "Sightseeing", color: "bg-purple-600" }, { icon: <Bus size={24} />, label: "Transfer", color: "bg-yellow-500" }, { icon: <Award size={24} />, label: "Highlights", color: "bg-orange-400" }].map((item, i) => (
            ...
            {activeMainTab === 'calculate price' && (
              <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  ...
                  <div><label className="block text-sm font-semibold text-gray-700 mb-2">Car/Bus Selection <span className="text-red-500">*</span></label>
          ...
          <div className="w-full lg:w-[32%] sticky top-28 space-y-6">
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <h2 className="text-3xl font-extrabold text-gray-800 mb-1">₹{displayedPrice.toLocaleString('en-IN')}</h2><p className="text-xs text-gray-500 mb-5">{isCalculated ? "Total Calculated Price" : "Starting price per adult"}</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> LUCKNOW26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 5K off on Heritage Tours*</p>
                </div>
              </div>
            </div>
          </div>
