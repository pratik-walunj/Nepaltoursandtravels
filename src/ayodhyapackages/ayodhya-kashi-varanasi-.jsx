...
import kashi from "../images/kashi page banner_1.jpg"
import kashivishhwanathtemplevaranasi from "../images/kashi-vishhwanath-temple-varanasi-india.jpg"
import ayodhyadarshan from "../images/ayodhyadarshan.jpeg"
...
// --- AYODHYA KASHI MOCK DATA ---
const packageData = {
  title: "Spiritual Divine: Ayodhya to Kashi",
  rating: 4.8,
  reviews: 950,
  duration: "4 Nights 5 Days",
  route: "Ayodhya (2N) → Kashi Varanasi (2N) → Sarnath",
  originalPrice: ".....",
  basePriceAdult: ".....",
  basePriceChildWithBed: ".....",
  basePriceChildWithoutBed: ".....",
  topBannerImage: RamMandir, 
  images: [
    kashi, 
    kashivishhwanathtemplevaranasi, 
    "https://images.unsplash.com/photo-1627894483216-2138af692e32?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
  ],
  itinerary: [
    {
      day: 1,
      ...
      description: "Welcome to the Holy Land of Lord Ram. Upon arrival at Ayodhya, our representative will transfer you to your hotel. In the evening, visit the banks of Saryu River for the divine Aarti and explore the local markets of the old city. Overnight stay in Ayodhya."
    },
    {
      day: 2,
      title: "Ram Janmabhoomi Darshan & Local Temples",
      image: ayodhyadarshan,
      description: "After breakfast, proceed for a full day of sightseeing. Visit the grand Shri Ram Janmabhoomi Temple, Hanuman Garhi, and Kanak Bhawan. Experience the spiritual peace at Mani Parvat before returning to your hotel. Overnight stay in Ayodhya."
    },
    {
      day: 3,
      title: "Drive to Kashi (Varanasi) & Evening Aarti",
      image: "https://images.unsplash.com/photo-1561359313-0639aad49ca6?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Check out and drive to Varanasi, the spiritual capital of India. Upon arrival, check-in to your hotel. In the evening, witness the soul-stirring Ganga Aarti at Dashashwamedh Ghat from a private boat. Overnight stay in Varanasi."
    },
    {
        day: 4,
        title: "Kashi Vishwanath Darshan & Sarnath Tour",
        image: Bodhgaya,
        description: "Early morning visit to Kashi Vishwanath Temple and Annapurna Temple. Later, enjoy a half-day excursion to Sarnath, where Buddha gave his first sermon. Visit Dhamekh Stupa and the Museum. Overnight stay in Varanasi."
    }
  ],
  highlights: [
    "5 Days Spiritual Journey Covering Ayodhya, Kashi & Sarnath with VIP Darshan Arrangements.",
    "Evening Saryu River Aarti in Ayodhya and Boat Ride in Varanasi.",
    "Guided visit to the Historical Sites of Sarnath.",
    "Comfortable Stay in Premium Hotels with Breakfast & Dinner Included.",
    "Read More"
  ],
  transfer: [
    "Airport/Railway station transfers in private AC vehicle.",
    "Inter-city transfers (Ayodhya - Varanasi) by comfortable AC SUV/Sedan.",
    "Local sightseeing transportation as per the itinerary.",
    "All toll taxes, parking fees, and driver allowances included."
  ],
  sightseeing: [
    "Ayodhya: Ram Janmabhoomi, Hanuman Garhi, Kanak Bhawan, Saryu River Ghats.",
    "Varanasi: Kashi Vishwanath Temple, Dashashwamedh Ghat, Kal Bhairav Temple.",
    "Sarnath: Dhamekh Stupa, Ashoka Pillar, Archaeological Museum."
  ],
  accommodation: [
    "Ayodhya: 2 Nights in a Premium Boutique Hotel (e.g., Cygnett Collection or similar).",
    "Varanasi: 2 Nights in a 4-star category hotel (e.g., Rivatas or similar)."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "Dinner included at hotels in Ayodhya and Varanasi.",
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "Professional local guide at Sarnath."
    ],
    exclusions: [
...
// --- NEW: VEHICLE DATA FOR CAPACITY LOGIC ---
const vehicleData = [
  { name: "Sedan (Dzire/Etios)", capacity: 4 },
  ...
  { name: "Coach Bus (45 Seater)", capacity: 45 },
];
...
const AyodhyaKashi = () => {
  ...
  // --- LOGIC: Calculate total persons for vehicle capacity ---
  ...
  const handleCalculatePrice = () => {
    ...
    if (!selectedVehicle) { setFormError("Please select a suitable Car/Bus."); return; }
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Ayodhya Kashi Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              ...
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Ayodhya Ram Mandir" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Kashi Varanasi" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
            ...
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              {[
                  { icon: <BedDouble size={24} />, label: "Hotel", color: "bg-pink-500" },
                  { icon: <Utensils size={24} />, label: "Meals", color: "bg-orange-500" },
                  { icon: <Camera size={24} />, label: "Sightseeing", color: "bg-purple-600" },
                  { icon: <Bus size={24} />, label: "Transfer", color: "bg-yellow-500" },
                  { icon: <Award size={24} />, label: "Highlights", color: "bg-orange-400" }
              ].map((item, i) => (
                <div key={i} className="flex flex-col items-center justify-center min-w-[80px]">
                  <div className={`w-14 h-14 rounded-full ${item.color} text-white flex items-center justify-center mb-2 shadow-md`}>{item.icon}</div>
                ...
                <div className="animate-fadeIn">
                   {activeSubTab !== 'inclusionexclusions' && (
                     <ul className="space-y-4">
                        {packageData[activeSubTab]?.map((item, index) => (
                          <li key={index} className="flex items-start text-sm text-gray-600 font-medium">
                            ...
                            <span className={item === "Read More" ? "text-red-600 cursor-pointer" : ""}>{item}</span>
                          </li>
                        ))}
                     </ul>
                   )}
                   ...
                   {activeSubTab === 'inclusionexclusions' && (
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                       <div>
                         ...
                         <ul className="space-y-4">
                           {packageData.inclusionExclusions.inclusions.map((item, i) => (
                             <li key={i} className="flex items-start text-sm text-gray-600 font-medium"><div className="min-w-[6px] h-[6px] rounded-full bg-green-500 mt-1.5 mr-3"></div>{item}</li>
                           ))}
                         </ul>
                       </div>
                       <div>
                         ...
                         <ul className="space-y-4">
                           {packageData.inclusionExclusions.exclusions.map((item, i) => (
                             <li key={i} className="flex items-start text-sm text-gray-600 font-medium"><div className="min-w-[6px] h-[6px] rounded-full bg-red-500 mt-1.5 mr-3"></div>{item}</li>
                           ))}
                         </ul>
                       </div>
                     </div>
            ...
            {activeMainTab === 'calculate price' && (
              <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 animate-fadeIn">
                ...
                {/* --- UPDATED: Selection Row with 3 Columns --- */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div>
                    ...
                    <select className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm text-gray-700 outline-none focus:border-red-400 bg-white">
                      <option>Gorakhpur</option><option>Pune</option>
                    </select>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      {vehicleData
                        .filter(v => v.capacity >= totalGuests)
                        .map((vehicle, index) => (
                          <option key={index} value={vehicle.name}>
                            {vehicle.name} (Max {vehicle.capacity})
                          </option>
                      ))}
                    </select>
                  </div>
                    ...
                    <div key={room.id} className="flex flex-col md:flex-row items-start md:items-center py-4 border-b border-gray-100">
                      <div className="w-full md:w-32 mb-4 md:mb-0 flex flex-col">
                        ...
                        {index === rooms.length - 1 && (
                          <button onClick={handleAddRoom} className="text-red-500 font-bold text-xs mt-1 self-start hover:underline">Add Room</button>
                        )}
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 mb-4">
                  <div>
                    ...
                    <input type="date" value={travelDate} onChange={(e) => setTravelDate(e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm text-gray-700 outline-none focus:border-red-400" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-2">
                  <div>
                    ...
                    <input type="tel" value={mobileNo} onChange={(e) => setMobileNo(e.target.value)} placeholder="10 digit number" className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm text-gray-700 outline-none focus:border-red-400" />
                  </div>
                  <div>
                ...
                {formError && (
                  <div className="text-red-600 text-sm font-bold bg-red-50 py-2 px-4 rounded mb-4 text-center border border-red-200">{formError}</div>
                )}

                <div className="flex flex-col items-center justify-center pt-4">
                  <label className="flex items-center text-sm text-gray-700 mb-4 cursor-pointer">
                    <input type="checkbox" checked={agreedToTerms} onChange={(e) => setAgreedToTerms(e.target.checked)} className="w-4 h-4 mr-2 accent-red-600 rounded cursor-pointer" />
                  ...
                  <button onClick={handleCalculatePrice} className="bg-red-600 hover:bg-red-700 text-white font-bold py-3.5 px-8 md:px-12 rounded shadow-md transition-colors text-base w-full md:w-auto">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +450</strong><br/>Holiday Reward points</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> HOLI2026</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 5K off on Holy Tours*</p>
                </div>
              </div>
            </div>
          </div>
