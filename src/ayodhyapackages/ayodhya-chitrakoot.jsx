...
import AyodhyaGhats from "../images/AyodhyaGhats.jpg"
import RamMandir from "../images/Ram-Mandir-Ayodhya-Tour.jpg"
import sarayughat from "../images/sarayu-ghat.jpg"
import { 
...
// --- AYODHYA CHITRAKOOT PACKAGE DATA ---
const packageData = {
  title: "Ramayana Path: Ayodhya to Chitrakoot",
  rating: 4.9,
  reviews: 420,
  ...
  images: [
    ...
    AyodhyaGhats, // Ayodhya Ghats
    RamMandir  // Spiritual River
  ],
  itinerary: [
    {
      day: 1,
      ...
      image: sarayughat,
      description: "Upon arrival in Ayodhya, check-in to your hotel. Later, visit the holy Saryu River for the evening Aarti. Explore the local markets of the old city. Overnight stay in Ayodhya."
    },
    {
      day: 2,
      title: "Ram Janmabhoomi & Ayodhya Sightseeing",
      image: RamMandir,
      description: "After breakfast, proceed for a divine Darshan of Shri Ram Janmabhoomi Temple. Visit Hanuman Garhi, Kanak Bhawan, and Mani Parvat. Spend the evening at leisure. Overnight stay in Ayodhya."
    },
    {
      day: 3,
      title: "Drive to Chitrakoot & Local Darshan",
      image: Chitrakoot,
      description: "Check out and drive to Chitrakoot, the place where Lord Rama spent 11 years of his exile. Visit Ram Ghat on the banks of Mandakini River, Kamadgiri, and Janaki Kund. Overnight stay in Chitrakoot."
    },
    {
      day: 4,
      title: "Chitrakoot Sightseeing & Departure",
      image: chitrakootbanner,
      description: "Visit Gupt Godavari Caves and Hanuman Dhara. After lunch, you will be transferred to the nearest airport or railway station for your onward journey."
    }
  ],
  highlights: [
    "4 Days Spiritual Ramayana Path covering Ayodhya and the exile land of Chitrakoot.",
    "Guided visit to Gupt Godavari Caves and Ram Janmabhoomi.",
    "Evening Mandakini River Aarti and Saryu River Aarti.",
    "Comprehensive transfers in a private AC vehicle.",
    "Read More"
  ],
  transfer: [
    "Pickup and Drop from Airport/Railway Station.",
    "Inter-city transfers in a comfortable private AC vehicle.",
    "All local sightseeing as per the itinerary.",
    "Toll taxes, parking fees, and driver allowances included."
  ],
  sightseeing: [
    "Ayodhya: Ram Janmabhoomi, Hanuman Garhi, Kanak Bhawan, Saryu River.",
    "Chitrakoot: Ram Ghat, Kamadgiri, Gupt Godavari, Janaki Kund, Hanuman Dhara."
  ],
  accommodation: [
    "Ayodhya: 2 Nights in a Premium Boutique Hotel.",
    "Chitrakoot: 1 Night in a 3-star category hotel."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "Traditional vegetarian dinner provided during the stay.",
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "Professional local guide at main sites."
    ],
    exclusions: [
      "Airfare or Train tickets.",
      "Monument entrance and boat fees.",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> Ramayana Path</div>
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Main" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden"><img src={packageData.images[1]} alt="Side 1" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Side 2" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-[32%] sticky top-28 space-y-6">
            ...
            {/* OFFERS SECTION (Newly Added to match Prayagraj) */}
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> RAMAYANA26</div>
...
export default AyodhyaChitrakoot;