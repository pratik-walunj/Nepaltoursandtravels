...
// --- KASHI TO GORAKHPUR PACKAGE DATA ---
const packageData = {
  title: "Heritage Route: Kashi to Gorakhpur Tour",
  rating: 4.7,
  reviews: 620,
  ...
  images: [
    VisitGorakhnathTemple, // Gorakhpur Temple
    kashipage, // Varanasi Ghats
  ...
  itinerary: [
    {
      ...
      image: GangaAarti,
      description: "Arrival at Varanasi. Transfer to hotel. In the evening, witness the soul-stirring Ganga Aarti at Dashashwamedh Ghat from a private boat. Experience the spiritual energy of the world's oldest living city. Overnight stay in Varanasi."
    },
    {
      day: 2,
      title: "Kashi Darshan & Drive to Gorakhpur",
      image: kashivishhwanath,
      description: "Early morning visit to Kashi Vishwanath Temple. After breakfast, check out and drive to Gorakhpur. Upon arrival, check-in to your hotel. Evening at leisure or visit the local heritage markets. Overnight stay in Gorakhpur."
    },
    {
      day: 3,
      title: "Gorakhnath Temple & Departure",
      image: VisitGorakhnathTemple,
      description: "Visit the world-famous Gorakhnath Temple and the historic Gita Press museum. Explore the Nirvana Sthal of Saint Kabir in Maghar if time permits. Later, transfer to Gorakhpur Railway Station or Airport for departure."
    }
  ],
  highlights: [
    "3 Days heritage tour connecting the spiritual depth of Kashi and Gorakhpur.",
    "VIP Darshan assistance at Kashi Vishwanath and Gorakhnath Temple.",
    "Visit to Gita Press, the world's largest publisher of Hindu texts.",
    "Comfortable private AC vehicle for all inter-city transfers.",
    "Read More"
  ],
  transfer: [
    "Pickup from Varanasi Airport/Railway Station.",
    "Inter-city transfer (Varanasi to Gorakhpur) in private AC vehicle.",
    "Local sightseeing in both cities as per itinerary.",
    "Toll taxes, parking, and driver allowances included."
  ],
  sightseeing: [
    "Kashi: Kashi Vishwanath Temple, Ganga Aarti, Dashashwamedh Ghat.",
    "Gorakhpur: Gorakhnath Temple, Gita Press Museum, Maghar."
  ],
  accommodation: [
    "Varanasi: 1 Night in a 3-star or 4-star category hotel.",
  ...
  meals: [
    ...
    "Traditional Satvik refreshments provided during transit."
  ],
  inclusionExclusions: {
    inclusions: [
      ...
      "Experienced driver-cum-guide for the circuit."
    ],
    exclusions: [
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> Heritage Route</div>
              ...
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                ...
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Ganga" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>
            ...
            {activeMainTab === 'calculate price' && (
              <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div><label className="block text-sm font-semibold text-gray-700 mb-2">Departure City <span className="text-red-500">*</span></label><select className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm text-gray-700 outline-none focus:border-red-400 bg-white"><option>Varanasi</option><option>Lucknow</option><option>Delhi</option></select></div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +350</strong><br/>Holiday Reward points</span>
...
export default KashiGorakhpurTour;