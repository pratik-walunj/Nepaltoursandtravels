...
import chitrakootbanner from "../images/chitrakootbanner.jpg"
import Chitrakoot from "../images/Chitrakoot2.jpg"
import kashipage from "../images/kashi page banner_1.jpg"
...
import guptgodavari from "../images/guptgodavari.jpg"
import { 
...
// --- KASHI TO CHITRAKOOT PACKAGE DATA ---
const packageData = {
  title: "Spiritual Forest: Kashi to Chitrakoot Tour",
  rating: 4.9,
  reviews: 480,
  ...
  images: [
    Chitrakoot, // Varanasi Ghats
    kashipage, // Chitrakoot Style
    GangaAarti  // Ganga Aarti
  ],
  itinerary: [
    {
      day: 1,
      title: "Arrival in Kashi & Evening Aarti",
      image: GangaAarti,
      description: "Arrival at Varanasi. Transfer to your hotel. In the evening, witness the soulful Ganga Aarti at Dashashwamedh Ghat. Explore the ancient lanes of Kashi and enjoy a boat ride on the sacred river. Overnight stay in Varanasi."
    },
    {
      day: 2,
      title: "Kashi Darshan & Sarnath Excursion",
      image: kashivishhwanath,
      description: "Early morning visit to Kashi Vishwanath Temple and Annapurna Temple. Later, drive to Sarnath to see the Dhamekh Stupa and Ashoka Pillar. Afternoon explore the local silk markets. Overnight stay in Varanasi."
    },
    {
      day: 3,
      title: "Drive to Chitrakoot & Local Sightseeing",
      image: Chitrakoot,
      description: "After breakfast, drive to Chitrakoot, where Lord Rama spent 11 years of exile. Visit Ram Ghat on the banks of Mandakini River, Kamadgiri, and Janaki Kund. Witness the evening Aarti at Mandakini river. Overnight stay in Chitrakoot."
    },
    {
      day: 4,
      title: "Chitrakoot Exploration & Departure",
      image: guptgodavari,
      description: "Morning visit to Gupt Godavari Caves and Hanuman Dhara. After local sightseeing, proceed to the nearest railway station or airport for your onward journey."
    }
  ],
  highlights: [
    "4 Days spiritual link connecting the oldest city Kashi to the sacred forests of Chitrakoot.",
    "VIP Darshan at Kashi Vishwanath and guided tour of Gupt Godavari Caves.",
    "Experience two unique River Aartis: Ganga Aarti (Varanasi) and Mandakini Aarti (Chitrakoot).",
    "Private AC vehicle for all inter-city and local transfers.",
    "Read More"
  ],
  transfer: [
    "Pickup from Varanasi Airport/Railway Station.",
    "Inter-city transfer (Varanasi to Chitrakoot) in private AC vehicle.",
    "Local sightseeing in both cities as per itinerary.",
    "All toll, parking, and driver allowances included."
  ],
  sightseeing: [
    "Kashi: Kashi Vishwanath, Dashashwamedh Ghat, Sarnath.",
    "Chitrakoot: Ram Ghat, Kamadgiri, Gupt Godavari, Janaki Kund, Hanuman Dhara."
  ],
  accommodation: [
    "Varanasi: 2 Nights in a 3-star or 4-star category hotel.",
    "Chitrakoot: 1 Night in a Deluxe category hotel or Premium Resort."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "1 bottle of packaged drinking water per person per day during transit.",
    "Traditional Satvik lunch experience in Chitrakoot."
  ],
  inclusionExclusions: {
    inclusions: [
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Kashi Chitrakoot" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> Spiritual Forest Tour</div>
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Kashi" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden"><img src={packageData.images[1]} alt="Chitrakoot" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Aarti" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>
            ...
            {activeMainTab === 'calculate price' && (
              <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div><label className="block text-sm font-semibold text-gray-700 mb-2">Departure City <span className="text-red-500">*</span></label><select className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm text-gray-700 outline-none focus:border-red-400 bg-white"><option>Varanasi</option><option>Ayodhya</option><option>Delhi</option></select></div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> CHITRA26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 5K off on Forest Circuit Tours*</p>
                </div>
              </div>
            </div>
          </div>
...
export default KashiChitrakootTour;