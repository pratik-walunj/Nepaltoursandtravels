...
import nepalbanners from "../images/nepalbanners.jpg"
import lumbin from "../images/lumbin.jpeg"
import KashiVaranasi from "../images/kashi page banner_1.jpg"
import VisitGorakhnathTemple from "../images/Visit-Gorakhnath-Temple.jpg"
import GangaAarti from "../images/kashi page banner_2.webp"
import kashivishhwanath from "../images/kashi-vishhwanath-temple-varanasi-india.jpg"
import lumbinibanner from "../images/lumbinibanner.png"
import Gorakhpurrailwaystation from "../images/Gorakhpurrailwaystation.jpg"
import { 
  MapPin, Calendar, Star, Share2, Heart, Download, 
  Minus, Plus, Info, BedDouble, Utensils, 
  Camera, Bus, Award, Users, Globe 
} from 'lucide-react';

// --- KASHI TO NEPAL BORDER PACKAGE DATA ---
const packageData = {
  title: "Cross Border Link: Kashi to Nepal Border",
  rating: 4.6,
  reviews: 510,
  ...
  images: [
    lumbin, // Lumbini / Border
    KashiVaranasi, // Varanasi
    VisitGorakhnathTemple  // Gorakhpur
  ],
  itinerary: [
    {
      day: 1,
      title: "Arrival in Kashi & Ganga Aarti",
      image:  GangaAarti,
      description: "Arrive at Varanasi and transfer to your hotel. In the evening, witness the divine Ganga Aarti at Dashashwamedh Ghat. Explore the ancient spiritual lanes of Kashi. Overnight stay in Varanasi."
    },
    {
      day: 2,
      title: "Varanasi Local Sightseeing",
      image: kashivishhwanath,
      description: "Early morning visit to Kashi Vishwanath Temple and Annapurna Temple. Later, visit Sarnath where Lord Buddha preached his first sermon. Evening free for shopping or boat rides. Overnight stay in Varanasi."
    },
    {
      day: 3,
      title: "Drive to Gorakhpur",
      image: VisitGorakhnathTemple,
      description: "After breakfast, drive towards Gorakhpur. Upon arrival, visit the Gorakhnath Temple and Gita Press. Explore the local heritage of the city. Overnight stay in Gorakhpur."
    },
    {
      day: 4,
      title: "Indo-Nepal Border (Sonauli) & Lumbini",
      image: lumbinibanner,
      description: "Proceed to Sonauli, the gateway to Nepal. After border formalities, enter Nepal and visit Lumbini, the birthplace of Lord Buddha. Explore Maya Devi Temple and various monasteries. Overnight stay in Sonauli or Lumbini."
    },
    {
      day: 5,
      title: "Departure",
      image: Gorakhpurrailwaystation,
      description: "After breakfast, complete local shopping and sightseeing. Later, transfer to Gorakhpur Railway Station or Airport for your return journey."
    }
  ],
  highlights: [
    "5 Days international link tour covering Varanasi, Gorakhpur, and the Nepal border.",
    "Hassle-free border crossing assistance at Sonauli Gateway.",
    "Guided spiritual tour of Lumbini, a UNESCO World Heritage site.",
    "Comfortable interstate AC vehicle for the entire journey.",
    "Read More"
  ],
  transfer: [
    "Pickup from Varanasi Airport/Railway Station.",
    "International border transit assistance at Sonauli.",
    "Private AC vehicle for all transfers and sightseeing.",
    "Vehicle permits, toll taxes, and driver allowances included."
  ],
  sightseeing: [
    "Kashi: Kashi Vishwanath, Ganga Aarti, Sarnath.",
    "Gorakhpur: Gorakhnath Temple, Gita Press.",
    "Nepal: Lumbini Garden, Maya Devi Temple, Monasteries."
  ],
  accommodation: [
    "Varanasi: 2 Nights in a 3-star or 4-star hotel.",
    "Gorakhpur: 1 Night in a Deluxe hotel.",
    "Nepal Border: 1 Night in a Standard/Deluxe hotel."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "Welcome drinks upon international border crossing.",
    "1 bottle of water per person per day."
  ],
  inclusionExclusions: {
    inclusions: [
      "Accommodation on twin-sharing basis.",
      "Indo-Nepal Vehicle Permit & Taxes.",
    ...
    exclusions: [
      ...
      "Monument entry fees.",
      "Nepal Visa fees (for non-Indian citizens).",
      "Personal expenses."
    ]
  }
};
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Nepal Border Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Globe size={14} className="mr-1" /> Cross Border Link</div>
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Lumbini" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden"><img src={packageData.images[1]} alt="Kashi" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Gorakhpur" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>
            ...
            {activeMainTab === 'calculate price' && (
              <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div><label className="block text-sm font-semibold text-gray-700 mb-2">Departure City <span className="text-red-500">*</span></label><select className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm text-gray-700 outline-none focus:border-red-400 bg-white"><option>Varanasi</option><option>Gorakhpur</option><option>Delhi</option></select></div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +480</strong><br/>Holiday Reward points</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> GATEWAY26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 5K off on Border Link Tours*</p>
                </div>
              </div>
            </div>
          </div>
