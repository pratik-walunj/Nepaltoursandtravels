...
// --- KASHI TO LUCKNOW PACKAGE DATA ---
const packageData = {
  title: "Nawab Heritage: Kashi to Lucknow Tour",
  rating: 4.8,
  reviews: 540,
  ...
  images: [
    Lucknow, // Lucknow Heritage
    kashipage, // Kashi Ghats
    GangaAarti  // Ganga Aarti
  ],
  itinerary: [
    {
      day: 1,
      title: "Arrival in Kashi & Evening Exploration",
      image: GangaAarti,
      description: "Arrival at Varanasi. Transfer to hotel. In the evening, witness the divine Ganga Aarti at Dashashwamedh Ghat. Explore the ancient lanes famous for silk weaving and traditional crafts. Overnight stay in Varanasi."
    },
    {
      day: 2,
      title: "Kashi Vishwanath Darshan & Drive to Lucknow",
      image: kashivishhwanath,
      description: "Early morning Darshan of Kashi Vishwanath Temple. After breakfast, check out and drive to the capital city, Lucknow. Upon arrival, check-in to your hotel. Evening visit to Hazratganj for shopping. Overnight stay in Lucknow."
    },
    {
      day: 3,
      title: "Lucknow Heritage Tour & Departure",
      image: luknow,
      description: "Visit the Bara Imambara, Chhota Imambara, and the Rumi Darwaza. Explore the British Residency and the lush Janeshwar Mishra Park. Afternoon transfer to Lucknow Airport or Railway Station for departure."
    }
  ],
  highlights: [
    "3 Days heritage link connecting the spiritual soul of Kashi with the Nawabi elegance of Lucknow.",
    "Guided architectural tour of Bara Imambara and British Residency.",
    "VIP Darshan at Kashi Vishwanath Temple.",
    "Experience the world-famous Awadhi cuisine in Lucknow.",
    "Read More"
  ],
  transfer: [
    "Pickup from Varanasi Airport/Railway Station.",
    "Inter-city transfer (Kashi to Lucknow) in private AC vehicle.",
    "Local sightseeing in both cities as per itinerary.",
    "All toll, parking, and driver allowances included."
  ],
  sightseeing: [
    "Kashi: Kashi Vishwanath, Ganga Aarti, Dashashwamedh Ghat.",
    "Lucknow: Bara Imambara, Rumi Darwaza, Residency, Hazratganj."
  ],
  accommodation: [
    "Varanasi: 1 Night in a 3-star or 4-star category hotel.",
    "Lucknow: 1 Night in a Heritage/Luxury category hotel."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "1 bottle of packaged drinking water per person per day.",
    "Traditional Awadhi dinner experience included."
  ],
  inclusionExclusions: {
    inclusions: [
      ...
      "Professional guide for heritage sites in Lucknow."
    ],
    exclusions: [
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Lucknow Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> Nawab Heritage</div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +420</strong><br/>Holiday Reward points</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> NAWAB26</div>
...
export default KashiLucknowTour;