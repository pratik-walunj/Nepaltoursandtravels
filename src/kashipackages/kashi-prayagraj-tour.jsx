...
// --- KASHI TO PRAYAGRAJ PACKAGE DATA ---
const packageData = {
  title: "Holy Sangam: Kashi to Prayagraj Tour",
  rating: 4.9,
  reviews: 980,
  ...
  itinerary: [
    {
      ...
      image: GangaAarti,
      description: "Arrival at Varanasi. Transfer to your hotel. In the evening, experience the spiritual grandeur of the Ganga Aarti at Dashashwamedh Ghat by boat. Explore the ancient lanes and temples of Kashi. Overnight stay in Varanasi."
    },
    {
      day: 2,
      title: "Kashi Darshan & Drive to Prayagraj",
      image: kashivishhwanath,
      description: "Morning Darshan of Kashi Vishwanath Temple and Annapurna Temple. After breakfast, drive to Prayagraj. Upon arrival, check-in to your hotel. Evening visit to the local markets and historical sites. Overnight stay in Prayagraj."
    },
    {
      day: 3,
      title: "Triveni Sangam Dip & Departure",
      image: TriveniSangam,
      description: "Early morning visit to Triveni Sangam for a holy dip. Visit Anand Bhawan, the reclining Hanuman Temple, and the Allahabad Fort. Afternoon transfer to Prayagraj Airport or Railway Station for your return journey."
    }
  ],
  highlights: [
    "3 Days spiritual tour covering the heart of the Holy Sangam and Ancient Kashi.",
    "Boat ride for Ganga Aarti in Varanasi and holy dip at Sangam in Prayagraj.",
  ...
  transfer: [
    ...
    "Inter-city transfer (Varanasi to Prayagraj) in private AC vehicle.",
    "Drop-off at Prayagraj Airport/Railway Station.",
    "All toll, parking, and driver allowances included."
  ],
  sightseeing: [
    "Kashi: Kashi Vishwanath, Dashashwamedh Ghat, Sarnath (Optional).",
    "Prayagraj: Triveni Sangam, Anand Bhawan, Hanuman Temple, Allahabad Fort."
  ],
  accommodation: [
    "Varanasi: 1 Night in a 3-star or 4-star category hotel.",
    "Prayagraj: 1 Night in a Deluxe category hotel."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "1 bottle of packaged drinking water per person per day during transit.",
    "Welcome traditional refreshment upon arrival in Kashi."
  ],
  inclusionExclusions: {
    inclusions: [
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Sangam Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md"><Users size={14} className="mr-1" /> Holy Sangam Tour</div>
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Sangam" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +400</strong><br/>Holiday Reward points</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> SANGAM26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 4K off on Holy Dip Tours*</p>
                </div>
              </div>
            </div>
          </div>
...
export default KashiPrayagrajTour;