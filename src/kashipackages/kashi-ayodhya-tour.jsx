...
// --- KASHI TO AYODHYA PACKAGE DATA ---
const packageData = {
  title: "Temple Circuit: Kashi to Ayodhya Tour",
  rating: 5.0,
  reviews: 1120,
  ...
  images: [
    KashiVaranasi, // Kashi Vishwanath area
     RamMandir, // Ayodhya Ram Mandir
    "https://images.unsplash.com/photo-1627894483216-2138af692e32?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"  // Ganga Aarti
  ],
  itinerary: [
    {
      day: 1,
      ...
      image: KashiVaranasi,
      description: "Arrival at Varanasi Airport/Railway Station. Transfer to hotel. In the evening, witness the world-famous Ganga Aarti at Dashashwamedh Ghat by boat. Visit the local markets of Kashi. Overnight stay in Varanasi."
    },
    {
      day: 2,
      title: "Kashi Vishwanath Darshan & Drive to Ayodhya",
      image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Early morning Darshan of Kashi Vishwanath Temple and Annapurna Temple. After breakfast, check out and drive to Ayodhya. Upon arrival, check-in to your hotel. Evening Saryu River Aarti. Overnight stay in Ayodhya."
    },
    {
      day: 3,
      title: "Ayodhya Ram Mandir Darshan & Departure",
      image: RamMandir,
      description: "Visit the grand Shri Ram Janmabhoomi Temple, Hanuman Garhi, and Kanak Bhawan. After lunch, transfer to Ayodhya Railway Station or Airport for your return journey."
    }
  ],
  highlights: [
    "3 Days Temple Circuit covering the two most sacred cities of Uttar Pradesh.",
    "VIP Darshan at Kashi Vishwanath and Shri Ram Janmabhoomi.",
    "Experience the mesmerizing Ganga Aarti in Kashi and Saryu Aarti in Ayodhya.",
    "Private AC vehicle for a comfortable inter-city spiritual journey.",
    "Read More"
  ],
  transfer: [
    "Pickup from Varanasi Airport/Railway Station.",
    "Inter-city transfer from Kashi to Ayodhya in private AC vehicle.",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Kashi Ayodhya Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              ...
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Varanasi" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden"><img src={packageData.images[1]} alt="Ayodhya Mandir" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +600</strong><br/>Holiday Reward points</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> SPIRITUAL26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 6K off on Temple Circuit Tours*</p>
                </div>
              </div>
            </div>
          </div>
...
export default KashiAyodhyaTour;