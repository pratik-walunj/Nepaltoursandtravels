...
// --- GORAKHPUR TO PRAYAGRAJ MOCK DATA ---
const packageData = {
  title: "Triveni Sangam Darshan: Gorakhpur to Prayagraj Tour",
  rating: 4.8,
  reviews: 580,
  ...
  images: [
    ...
    Gorakhpurrailwaystation, // Boats
    Gorakhpur  // Temple/Fort Architecture
  ],
  itinerary: [
    {
      day: 1,
      title: "Drive from Gorakhpur & Triveni Sangam Boat Ride",
      image: GangaAarti,
      description: "Our representative will warmly receive you at the Gorakhpur Railway Station, Airport, or your residence. Enjoy a comfortable AC drive (approx. 5-6 hours) to the holy city of Prayagraj. Upon arrival, check into your hotel and relax. In the afternoon, head to the Triveni Sangam—the sacred confluence of the Ganga, Yamuna, and the mythical Saraswati rivers. Enjoy a peaceful boat ride to the exact meeting point and take a holy dip. In the evening, witness the beautiful riverbank Aarti. Overnight stay in Prayagraj."
    },
    {
      day: 2,
      title: "Local Sightseeing & Return to Gorakhpur",
      image: Gorakhpur,
      description: "After breakfast, proceed to visit the highly revered Bade Hanuman Ji Temple, famous for its unique sleeping idol of Lord Hanuman. Next, explore the Allahabad Fort (exterior and permitted areas) which houses the Patalpuri Temple and the immortal Akshayavat tree. Later, visit Anand Bhawan, the historic ancestral home of the Nehru family, and the adjacent Swaraj Bhawan. After lunch, we will begin the return journey to Gorakhpur, where you will be dropped off at your chosen location."
    }
  ],
  highlights: [
    "Take a holy dip at the Triveni Sangam, the confluence of three sacred rivers.",
    "Enjoy a serene boat ride on the waters of the Ganges and Yamuna.",
    "Seek blessings at the unique sleeping idol of Bade Hanuman Ji.",
    "Explore India's political history at Anand Bhawan and Swaraj Bhawan.",
    "Comfortable and fast round-trip transfer from Gorakhpur."
  ],
  transfer: [
    "Pick-up from Gorakhpur Railway Station / Airport / Residence.",
    "Round-trip inter-city transfers (Gorakhpur - Prayagraj - Gorakhpur) by private AC vehicle.",
    "All local sightseeing in Prayagraj as per the itinerary.",
    "All toll taxes, parking fees, fuel, and driver allowances included."
  ],
  sightseeing: [
    "Prayagraj Rivers: Triveni Sangam, Boat Ride.",
    "Temples: Bade Hanuman Ji Temple, Patalpuri Temple, Akshayavat.",
    "Historical Sites: Anand Bhawan, Swaraj Bhawan, Allahabad Fort (permitted areas)."
  ],
  accommodation: [
    "Prayagraj: 1 Night in a 3-star or 4-star premium category hotel."
  ],
  meals: [
    "1 Buffet Breakfast at the hotel in Prayagraj.",
    "Welcome drink upon arrival at the hotel.",
    "1 bottle of packaged drinking water per person per day during travel."
  ],
  inclusionExclusions: {
    inclusions: [
      "Accommodation on a twin-sharing basis for 1 Night.",
    ...
    exclusions: [
      ...
      "Lunches and Dinners.",
      "Monument and museum entrance fees (e.g., Anand Bhawan).",
      "Travel and Medical Insurance.",
      "Personal expenses (laundry, tips, telephone, shopping, special pujas)."
    ]
  }
};
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Gorakhpur to Prayagraj Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              ...
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Triveni Sangam" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Prayagraj Boats" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Anand Bhawan / Fort" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +200</strong><br/>Holiday Reward points on this booking</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> PRAYAG10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Prayagraj Sangam Tours*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
...
export default GorakhpurToPrayagraj;