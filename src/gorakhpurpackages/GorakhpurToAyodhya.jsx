...
import ayodhyaghat from "../images/AyodhyaGhats.jpg"
import HanumanGarhi from "../images/HanumanGarhi.jpg"
// --- GORAKHPUR TO AYODHYA MOCK DATA ---
const packageData = {
  title: "Ram Janmabhoomi Darshan: Gorakhpur to Ayodhya Tour",
  rating: 4.9,
  reviews: 1240,
  ...
  images: [
    ...
    HanumanGarhi, // Saryu River Ghats
    "https://images.unsplash.com/photo-1570168007204-dfb528c6958f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"  // Temple Architecture
  ],
  itinerary: [
    {
      day: 1,
      title: "Drive from Gorakhpur to Ayodhya & Evening Saryu Aarti",
      image: HanumanGarhi,
      description: "Our representative will warmly receive you at the Gorakhpur Railway Station, Airport, or your residence. Board your comfortable AC vehicle and enjoy a smooth 3-hour drive to the holy city of Ayodhya. Upon arrival, check into your hotel and freshen up. Later, visit the highly revered Hanuman Garhi temple and Kanak Bhawan. In the evening, head to Naya Ghat to witness the divine and spectacular Saryu River Aarti. Overnight stay in Ayodhya."
    },
    {
      day: 2,
      title: "Ram Janmabhoomi Darshan & Return Journey",
      image: "https://images.unsplash.com/photo-1570168007204-dfb528c6958f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Wake up early and after breakfast, proceed for the much-awaited darshan at the magnificent Ram Janmabhoomi Temple. Experience the spiritual aura of Lord Rama's birthplace. Next, visit Dashrath Mahal, Treta Ke Thakur, and Nageshwarnath Temple. Spend some time exploring the local markets to buy religious souvenirs and Prasad. After lunch, we will begin our return journey to Gorakhpur, where you will be dropped off at your designated location."
    }
  ],
  highlights: [
    "VIP/Standard Darshan at the grand Ram Janmabhoomi Temple.",
    "Witness the breathtaking evening Aarti at the banks of the Saryu River.",
    "Seek blessings at the famous Hanuman Garhi and Kanak Bhawan.",
    "Explore the ancient Dashrath Mahal and Nageshwarnath Temple.",
    "Comfortable and fast round-trip transfer from Gorakhpur."
  ],
  transfer: [
    "Pick-up from Gorakhpur Railway Station / Airport / Residence.",
    "Round-trip inter-city transfers (Gorakhpur - Ayodhya - Gorakhpur) by private AC vehicle.",
    "All local sightseeing in Ayodhya as per the itinerary.",
    "All toll taxes, parking fees, fuel, and driver allowances included."
  ],
  sightseeing: [
    "Ayodhya Temples: Ram Janmabhoomi, Hanuman Garhi, Kanak Bhawan.",
    "Historical Sites: Dashrath Mahal, Nageshwarnath Temple, Treta Ke Thakur.",
    "Ghats: Evening Saryu River Aarti at Naya Ghat, Guptar Ghat."
  ],
  accommodation: [
    "Ayodhya: 1 Night in a 3-star or 4-star premium category hotel."
  ],
  meals: [
    "1 Buffet Breakfast at the hotel in Ayodhya.",
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "Local assistance for temple darshans in Ayodhya."
    ],
    exclusions: [
      "Train/Airfare to reach Gorakhpur.",
      "Lunches and Dinners.",
      "Special VIP Darshan tickets or Puja offerings.",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Gorakhpur to Ayodhya Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              ...
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Ayodhya Temple" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Saryu Aarti" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Hanuman Garhi" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              ...
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                ...
                <span className="text-xs font-semibold text-gray-700">Aarti View</span>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> AYODHYA10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Ayodhya Darshan Tours*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> RAM26</div>
...
export default GorakhpurToAyodhya;