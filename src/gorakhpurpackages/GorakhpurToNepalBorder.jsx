...
// --- GORAKHPUR TO NEPAL BORDER MOCK DATA ---
const packageData = {
  title: "Gateway to the Himalayas: Gorakhpur to Nepal Border Tour",
  rating: 4.7,
  reviews: 412,
  duration: "1 Night 2 Days",
  route: "Gorakhpur (1N) → Sunauli Border Drop",
  originalPrice: 6500,
  basePriceAdult: 4500,
  basePriceChildWithBed: 2500,
  basePriceChildWithoutBed: 1500,
  ...
  images: [
    "https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80", // Temple/Gorakhnath Vibe
    "https://images.unsplash.com/photo-1518002054494-3a6f94352e9d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", // Highway/Travel
    sunauli  // Welcome to Nepal Vibe
  ],
  itinerary: [
    {
      day: 1,
      title: "Arrival & Gorakhpur Local Sightseeing",
      image: "https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Our representative will warmly welcome you at the Gorakhpur Railway Station or Airport. Check into your hotel and freshen up. In the afternoon, begin your local sightseeing by visiting the highly revered Gorakhnath Temple, the seat of the Nath monastic order. Later, visit the historic Gita Press, one of the world's largest publishers of Hindu religious texts, and spend a relaxing evening at Ramgarh Taal. Overnight stay in Gorakhpur."
    },
    {
      day: 2,
      title: "Drive to Sunauli (Indo-Nepal Border) & Drop-off",
      image: sunauli,
      description: "After a hearty breakfast, check out from your hotel. Embark on a comfortable and scenic drive (approx. 2.5 to 3 hours) towards Sunauli, the primary land crossing point between India and Nepal. Upon reaching the border, our driver will assist you with the basic border crossing formalities. You can explore the local border markets before crossing into Bhairahawa, Nepal, for your onward Himalayan journey."
    }
  ],
  highlights: [
    "Seek blessings at the famous Gorakhnath Temple in Gorakhpur.",
    "Visit the historic Gita Press and enjoy the views at Ramgarh Taal.",
    "Comfortable, AC private transfer from Gorakhpur to the Sunauli border.",
    "Assistance with Indo-Nepal border crossing formalities.",
    "Perfect transit package for travelers heading to Lumbini or Pokhara."
  ],
  transfer: [
    "Pick-up from Gorakhpur Railway Station / Airport / Residence.",
    "Inter-city transfer (Gorakhpur to Sunauli Border) by private AC vehicle.",
    "Drop-off right at the Sunauli / Bhairahawa border crossing.",
    "All toll taxes, parking fees, fuel, and driver allowances included."
  ],
  sightseeing: [
    "Gorakhpur: Gorakhnath Temple, Gita Press, Ramgarh Taal.",
    "Sunauli: Indo-Nepal Border transit and local market."
  ],
  accommodation: [
    "Gorakhpur: 1 Night in a 3-star or 4-star premium category hotel."
  ],
  meals: [
    "1 Buffet Breakfast at the hotel in Gorakhpur.",
    "Welcome drink upon arrival at the hotel.",
    "1 bottle of packaged drinking water per person per day during travel."
  ],
  inclusionExclusions: {
    inclusions: [
      "Accommodation on a twin-sharing basis for 1 Night in Gorakhpur.",
      "Breakfast at the hotel.",
      "All transfers and local sightseeing by dedicated AC vehicle.",
      "Driver allowance, parking, and toll taxes.",
      "Basic guidance for Nepal border entry formalities."
    ],
    exclusions: [
      "Train/Airfare to reach Gorakhpur.",
      "Lunches and Dinners.",
      "Nepal Entry Visa fees (if applicable for non-Indian nationals).",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Gorakhpur to Nepal Border Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md">
                <Users size={14} className="mr-1" /> Transit & Tour
              </div>
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Gorakhnath Temple" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Highway Travel" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Nepal Border" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              ...
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                ...
                <span className="text-xs font-semibold text-gray-700">Assistance</span>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +150</strong><br/>Holiday Reward points on this booking</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> SUNAULI10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Border Transit Tours*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
...
export default GorakhpurToNepalBorder;