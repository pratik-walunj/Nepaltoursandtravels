...
import baraimambar from "../images/baraimambar.jpg"
// --- GORAKHPUR TO LUCKNOW MOCK DATA ---
const packageData = {
  title: "City of Nawabs: Gorakhpur to Lucknow Tour",
  rating: 4.8,
  reviews: 620,
  ...
  images: [
    ...
    rumidarwaza, // Monuments
    ambedkar  // Heritage Vibe
  ],
  itinerary: [
    {
      day: 1,
      title: "Drive to Lucknow, Bara Imambara & Heritage Tour",
      image: baraimambar,
      description: "Our representative will pick you up from your designated location in Gorakhpur. Enjoy a smooth and scenic drive (approx. 4-5 hours) to Lucknow via the Purvanchal Expressway. Check into your hotel and relax. After lunch, begin your heritage tour by visiting the magnificent Bara Imambara and its famous Bhool Bhulaiya (labyrinth). Next, visit the stunning Chhota Imambara and take photos at the iconic Rumi Darwaza. In the evening, explore the bustling Hazratganj market. Overnight stay in Lucknow."
    },
    {
      day: 2,
      title: "The Residency, Local Shopping & Return Journey",
      image: Gorakhpur,
      description: "After a delicious breakfast, visit the British Residency, a historic site that played a major role during the 1857 uprising. Later, take a peaceful stroll at the beautiful Ambedkar Memorial Park or Gomti Riverfront. Don't forget to shop for world-famous Chikankari clothes in Chowk or Aminabad, and indulge in the mouth-watering local Awadhi cuisine (like Tunday Kababi). In the late afternoon, we will begin the return journey to Gorakhpur for your final drop-off."
    }
  ],
  highlights: [
    "Explore the architectural marvel of Bara Imambara and its Bhool Bhulaiya.",
    "Click photos at the majestic Rumi Darwaza, the symbol of Lucknow.",
    "Visit the historic ruins of The British Residency.",
    "Shop for exquisite, world-famous Chikankari embroidery.",
    "Taste authentic and royal Awadhi cuisine."
  ],
  transfer: [
    "Pick-up from Gorakhpur Railway Station / Airport / Residence.",
    "Round-trip inter-city transfers (Gorakhpur - Lucknow - Gorakhpur) by private AC vehicle.",
    "All local sightseeing in Lucknow as per the itinerary.",
    "All toll taxes, parking fees, fuel, and driver allowances included."
  ],
  sightseeing: [
    "Heritage Sites: Bara Imambara, Chhota Imambara, Rumi Darwaza.",
    "Historical Landmarks: The British Residency, Husainabad Clock Tower.",
    "Parks & Leisure: Ambedkar Memorial Park, Gomti Riverfront, Hazratganj."
  ],
  accommodation: [
    "Lucknow: 1 Night in a 3-star or 4-star premium category hotel."
  ],
  meals: [
    "1 Buffet Breakfast at the hotel in Lucknow.",
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "Driver allowance, parking, and expressway toll taxes.",
      "Local assistance for shopping and food exploration."
    ],
    exclusions: [
      "Train/Airfare to reach Gorakhpur.",
      "Lunches and Dinners (try local Awadhi food).",
      "Monument and museum entrance fees (e.g., Bara Imambara).",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Gorakhpur to Lucknow Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md">
                <Users size={14} className="mr-1" /> Heritage Tour
              </div>
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Bara Imambara" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Rumi Darwaza" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Ambedkar Park" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              ...
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                ...
                <span className="text-xs font-semibold text-gray-700">Culture</span>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> LUCKNOW10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Lucknow Heritage Tours*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
...
export default GorakhpurToLucknow;