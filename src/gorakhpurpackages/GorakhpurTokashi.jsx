...
import sarnathkashi from "../images/sarnathkashi.jpg";
import varanasighat from "../images/varanasighat.jpg"
// --- GORAKHPUR TO KASHI (VARANASI) MOCK DATA ---
const packageData = {
  title: "Divine Kashi: Gorakhpur to Varanasi Tour",
  rating: 4.8,
  reviews: 845,
  ...
  images: [
    ...
    varanasighat, // Ganga Aarti

   sarnathkashi  // Sarnath/Temples
  ],
  itinerary: [
    {
      day: 1,
      title: "Drive from Gorakhpur to Kashi & Evening Ganga Aarti",
      image: gangaarti,
      description: "Our representative will pick you up from Gorakhpur Railway Station/Airport or your residence. Begin your spiritual journey with a scenic drive to the holy city of Kashi (Varanasi). Upon arrival, check into your hotel and rest. In the evening, head towards Dashashwamedh Ghat to witness the world-famous, mesmerizing Ganga Aarti. Experience the divine atmosphere as the priests perform rituals with grand oil lamps. Overnight stay in Varanasi."
    },
    {
      day: 2,
      title: "Morning Boat Ride, Kashi Vishwanath Darshan & Sarnath",
      image: sarnathkashi,
      description: "Wake up early before sunrise for a serene boat ride on the River Ganges. Witness the locals performing morning rituals at the historic ghats. Afterward, proceed for a VIP/Standard Darshan at the sacred Kashi Vishwanath Temple (one of the 12 Jyotirlingas) and the Annapurna Temple. Return to the hotel for breakfast. In the afternoon, drive to Sarnath, where Lord Buddha gave his first sermon. Visit the Dhamek Stupa, Chaukhandi Stupa, and the Sarnath Archaeological Museum. Overnight stay in Varanasi."
    },
    {
      day: 3,
      title: "Local Temples, Shopping & Return to Gorakhpur",
      image: gorakhpur,
      description: "After breakfast, visit the famous Sankat Mochan Temple, Tulsi Manas Temple, and the new Vishwanath Temple inside the Banaras Hindu University (BHU) campus. Spend some time exploring the narrow lanes of Kashi, where you can shop for world-renowned Banarasi silk sarees, rudraksha, and local handicrafts. After lunch, begin your return journey to Gorakhpur. You will be dropped off at your designated location in Gorakhpur."
    }
  ],
  highlights: [
    "Witness the spectacular and divine evening Ganga Aarti at Dashashwamedh Ghat.",
    "Experience a peaceful early morning boat ride on the River Ganges.",
    "Seek blessings at the highly revered Kashi Vishwanath Jyotirlinga Temple.",
    "Explore the ancient Buddhist ruins and stupas at Sarnath.",
    "Comfortable, hassle-free private transfers from Gorakhpur."
  ],
  transfer: [
    "Pick-up from Gorakhpur Railway Station / Airport / Residence.",
    "Round-trip inter-city transfers (Gorakhpur - Varanasi - Gorakhpur) by private AC vehicle.",
    "All local sightseeing in Varanasi and Sarnath as per the itinerary.",
    "All toll taxes, parking fees, fuel, and driver allowances included."
  ],
  sightseeing: [
    "Varanasi Ghats: Dashashwamedh Ghat, Assi Ghat, Manikarnika Ghat.",
    "Temples: Kashi Vishwanath, Annapurna, Sankat Mochan, BHU Vishwanath.",
    "Sarnath: Dhamek Stupa, Chaukhandi Stupa, Sarnath Museum."
  ],
  accommodation: [
    "Varanasi: 2 Nights in a 3-star or 4-star premium category hotel (near City Center or Ghats)."
  ],
  meals: [
    "Daily buffet breakfast at the hotel in Varanasi.",
    "Welcome drink upon arrival at the hotel.",
    "1 bottle of packaged drinking water per person per day during travel."
  ],
  inclusionExclusions: {
    inclusions: [
      "Accommodation on a twin-sharing basis for 2 Nights.",
    ...
    exclusions: [
      ...
      "Lunches and Dinners.",
      "Special VIP Darshan tickets at Kashi Vishwanath Temple.",
      "Monument and Museum entrance fees (e.g., Sarnath).",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Gorakhpur to Kashi Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md">
                <Users size={14} className="mr-1" /> Spiritual Tour
              </div>
              ...
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Ganga Aarti" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Kashi Temples" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              ...
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                ...
                <span className="text-xs font-semibold text-gray-700">Boat Ride</span>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +350</strong><br/>Holiday Reward points on this booking</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> KASHI10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Varanasi Temple Tours*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> UP26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto ₹2500 off on Credit Cards*</p>
                </div>
              </div>
            </div>
...
export default GorakhpurToKashi;