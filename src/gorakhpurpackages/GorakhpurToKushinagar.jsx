...
import ramabhar from "../images/ramabhar.jpg"
import vaishalipillarkhushinagar from "../images/vaishalipillarkhushinagar.jpg";
import gorakhpur from "../images/gorakhpur.png";
// --- GORAKHPUR TO KUSHINAGAR MOCK DATA ---
const packageData = {
  title: "Mahaparinirvana Circuit: Gorakhpur to Kushinagar Tour",
  rating: 4.8,
  reviews: 320,
  duration: "1 Night 2 Days",
  route: "Gorakhpur → Kushinagar (1N) → Gorakhpur Drop",
  originalPrice: 8500,
  basePriceAdult: 5500,
  basePriceChildWithBed: 3500,
  ...
  images: [
    ...
    ramabhar, // Stupa / Ruins
    vaishalipillarkhushinagar  // Temple Architecture
  ],
  itinerary: [
    {
      day: 1,
      title: "Gorakhnath Darshan & Drive to Kushinagar",
      image: "https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Our representative will warmly welcome you at Gorakhpur Railway Station or Airport. Begin your journey by seeking blessings at the revered Gorakhnath Temple. Afterwards, embark on a short, comfortable drive (approx. 1.5 hours) to Kushinagar, one of the four most sacred Buddhist pilgrimage sites. Upon arrival, check into your hotel. In the afternoon, visit the Mahaparinirvana Temple, which houses the iconic 6.1-meter-long statue of the reclining Buddha, and the Ramabhar Stupa, the holy cremation site of Lord Buddha. Overnight stay in Kushinagar."
    },
    {
      day: 2,
      title: "International Monasteries & Return to Gorakhpur",
      image: gorakhpur,
      description: "After a peaceful breakfast, head out to explore the beautifully manicured international monasteries in Kushinagar. Visit the Wat Thai Temple, the Indo-Japan-Sri Lanka Temple, and the Matha Kuar Shrine, which features a giant statue of Buddha carved from a single blue stone. Soak in the tranquil atmosphere before we begin our short return drive to Gorakhpur. You will be dropped off at the Gorakhpur Railway Station or Airport for your onward journey."
    }
  ],
  highlights: [
    "Pay your respects at the Mahaparinirvana Temple (Reclining Buddha).",
    "Visit the historic Ramabhar Stupa, the cremation site of Lord Buddha.",
    "Explore the stunning Thai, Japanese, and Sri Lankan Monasteries.",
    "Seek blessings at the famous Gorakhnath Temple in Gorakhpur.",
    "Comfortable and fast round-trip transfer from Gorakhpur."
  ],
  transfer: [
    "Pick-up from Gorakhpur Railway Station / Airport / Residence.",
    "Round-trip inter-city transfers (Gorakhpur - Kushinagar) by private AC vehicle.",
    "All local sightseeing in Kushinagar as per the itinerary.",
    "All toll taxes, parking fees, fuel, and driver allowances included."
  ],
  sightseeing: [
    "Gorakhpur: Gorakhnath Temple Darshan.",
    "Kushinagar: Mahaparinirvana Temple, Ramabhar Stupa, Matha Kuar Shrine.",
    "Kushinagar Monasteries: Wat Thai Temple, Indo-Japan-Sri Lanka Temple."
  ],
  accommodation: [
    "Kushinagar: 1 Night in a 3-star or 4-star premium category peaceful hotel."
  ],
  meals: [
    "1 Buffet Breakfast at the hotel in Kushinagar.",
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "Local assistance for temple visits in Kushinagar."
    ],
    exclusions: [
      "Train/Airfare to reach Gorakhpur.",
      "Lunches and Dinners.",
      "Monument and Museum entrance fees (if applicable).",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Gorakhpur to Kushinagar Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              ...
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Kushinagar Temple" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Ramabhar Stupa" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Monastery" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              ...
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                ...
                <span className="text-xs font-semibold text-gray-700">Darshan</span>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> KUSHINAGAR10</div>
...
export default GorakhpurToKushinagar;