...
// Placeholders: Aap apni actual Mercedes SLK images yahan import karein
import mercedesslkview from "../images/mercedesslkview.png"; // Replace with SLK image
import mercedesslkfrontview from "../images/mercedesslkfrontview.png"; // Replace with SLK image
import mercedesslkbackview from "../images/mercedesslkbackview.png"; // Replace with SLK image

// Master Data specifically configured for Mercedes SLK
const masterFleetData = [
  { 
    ...
    type: "Mercedes-Benz", 
    models: "MERCEDES SLK", 
    seats: "2 SEATS", // 2-Seater Convertible Roadster
    bags: "1 BAG", // Limited boot space due to folding roof
    pricePerKm: 70, // Premium sports car pricing
    rating: 4.9, 
    isAc: true, 
    img: mercedesslkview,
    description: "The Mercedes-Benz SLK is a striking luxury convertible roadster that delivers thrilling performance and open-top driving pleasure. Featuring a retractable hardtop, a driver-focused cockpit with premium leather sports seats, and dynamic handling, it is the ultimate expression of automotive passion. Whether cruising along coastal highways or making a grand entrance at a high-profile event, the SLK offers an unforgettable blend of elegance and adrenaline."
  }
];
...
const CabDetails = () => {
  ...
  useEffect(() => {
    const foundCar = masterFleetData.find(car => car.path === carName) || masterFleetData.find(car => car.id === 105);
    setCarData(foundCar);
  }, [carName]);
  ...
  // Structuring data for Mercedes SLK
  const details = {
    brand: carData.type.toUpperCase(),
    model: carData.models.toUpperCase(),
    category: "LUXURY CONVERTIBLE", // Sports Roadster Category
    driveType: "CHAUFFEUR DRIVEN", // Can also be SELF DRIVE depending on your service
    description: carData.description,
    images: [
      carData.img, 
      mercedesslkfrontview, 
     mercedesslkbackview
    ],
    features: [
      `${carData.seats}`,
