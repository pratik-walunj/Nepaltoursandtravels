...
// Placeholders: Aap apni actual 65-Seater Bus images yahan import karein
import acbus65seater from "../images/acbus65seater.png"; // Replace with Bus image
import acbus65seaterfronview from "../images/acbus65seaterfrontview.png"; // Replace with Bus image
import acbus65seaterbackview from "../images/acbus65seaterbackview.png"; // Replace with Bus image

// Master Data specifically configured for Luxury 65-Seater Bus
const masterFleetData = [
  { 
    id: 205, 
    path: "luxury-65-seater-ac-bus", 
    type: "Bus", 
    models: "65 SEATER LUXURY BUS", 
    seats: "65 SEATS", 
    bags: "65 BAGS", // Massive underbelly luggage capacity
    pricePerKm: 85, // Large commercial vehicle pricing
    rating: 4.7, 
    isAc: true, 
    img: acbus65seater,
    description: "The 65-Seater Luxury AC Bus is the ultimate mobility solution for massive group movements without compromising on comfort. Perfect for grand wedding parties, large corporate offsites, and extensive outstation tours, this heavy-duty coach features premium pushback seating, individual AC vents, and a state-of-the-art entertainment system. With an expansive underbelly luggage compartment and advanced air-suspension for a bump-free ride, it ensures that your entire group travels together in absolute comfort and safety."
  }
];
...
const CabDetails = () => {
  ...
  useEffect(() => {
    const foundCar = masterFleetData.find(car => car.path === carName) || masterFleetData.find(car => car.id === 205);
    setCarData(foundCar);
  }, [carName]);
  ...
  // Structuring data for 65-Seater Bus
  const details = {
    ...
    images: [
      carData.img, 
      acbus65seaterfronview, 
      acbus65seaterbackview 
    ],
    features: [
      `${carData.seats}`,
  ...
  // Mock Packages Data (Commercial Large Coach Pricing)
  const packagesData = [
    {
      id: 'city',
    ...
    {
      id: 'airport',
      title: 'LARGE GROUP AIRPORT TRANSFER',
      basePrice: 12000,
      extraKmRate: 0,
      extraHrRate: 0,
      hasExtras: false
