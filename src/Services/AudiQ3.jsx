...
import audiq3view from "../images/audiq3view.png" // Placeholder imports, replace with actual Q3 images
import audiq3frontview from "../images/audiq3frontview.png";
import audiq3backview from "../images/audiq3backview.png"

// Master Data specifically configured for Audi Q3
const masterFleetData = [
  { 
    ...
    seats: "5 SEATS", 
    bags: "3 BAGS", 
    pricePerKm: 35, // Adjusted pricing for Q3
    rating: 4.8, 
    isAc: true, 
    // High-quality placeholder image for testing (you can replace with your actual Q3 image)
    img: audiq3view,
    description: "The Audi Q3 is a versatile luxury compact SUV that perfectly combines sporty design, everyday functionality, and advanced technology. Featuring a spacious, ergonomic interior with premium leather upholstery and customizable ambient lighting, it offers a highly comfortable ride for both city commutes and outstation getaways. With superior suspension, a raised seating position, and a striking road presence, the Audi Q3 is the ideal choice for those who want adventure without compromising on premium luxury."
  }
];
...
const CabDetails = () => {
  ...
  // 1. Fetch Data UseEffect (Defaults to Audi Q3 if no path is given for testing)
  useEffect(() => {
    const foundCar = masterFleetData.find(car => car.path === carName) || masterFleetData.find(car => car.id === 102);
    setCarData(foundCar);
  }, [carName]);
  ...
  // Structuring data for Audi Q3
  const details = {
    brand: carData.type.toUpperCase(),
    model: carData.models.toUpperCase(),
    category: "LUXURY COMPACT SUV", // Updated Category
    driveType: "CHAUFFEUR DRIVEN",
    description: carData.description,
    images: [
      carData.img, // Side View
      audiq3frontview, // Placeholder: Front Angle View
      audiq3backview  // Placeholder: Back Angle View
    ],
    features: [
      `${carData.seats}`,
  ...
  // Mock Packages Data (Adjusted pricing for a Premium Compact SUV)
  const packagesData = [
    {
      id: 'city',
