...
// Placeholders: Aap apni actual Jaguar XE images yahan import karein
import jaguarxeview from "../images/jaguarxeview.png"; // Replace with Jaguar XE image
import jaguarxefrontview from "../images/jaguarxefrontview.png"; // Replace with Jaguar XE image
import jaguarxebackview from "../images/jaguarxebackview.png"; // Replace with Jaguar XE image

// Master Data specifically configured for Jaguar XE
const masterFleetData = [
  { 
    ...
    seats: "5 SEATS", 
    bags: "3 BAGS", 
    pricePerKm: 45, // Premium luxury sedan pricing
    rating: 4.8, 
    isAc: true, 
    img: jaguarxeview,
    description: "The Jaguar XE perfectly blends sports car dynamics with premium executive luxury. Known for its agile handling, lightweight aluminum architecture, and aerodynamic silhouette, it delivers an exhilarating yet highly refined driving experience. Step inside to a driver-focused cockpit featuring premium leather, state-of-the-art infotainment, and meticulously crafted details. Whether it's a high-profile corporate transfer or a stylish weekend getaway, the Jaguar XE makes a bold, unmistakable statement on the road."
  }
];
...
const CabDetails = () => {
  ...
  useEffect(() => {
    const foundCar = masterFleetData.find(car => car.path === carName) || masterFleetData.find(car => car.id === 106);
    setCarData(foundCar);
  }, [carName]);
  ...
  // Structuring data for Jaguar XE
  const details = {
