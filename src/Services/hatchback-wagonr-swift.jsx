...
// Assets - Replace with your actual Maruti Suzuki WagonR images
...
const masterFleetData = [
  { 
    ...
    isAc: true, 
    img: wagonRMain,
    description: "The Maruti Suzuki WagonR is the iconic 'Tall Boy' hatchback designed for city efficiency and surprisingly spacious interiors. Perfect for solo travelers or small groups, it offers excellent visibility and easy ingress/egress. With its compact footprint and reliable AC, it is the most economical and practical choice for navigating busy urban streets and short-distance transfers."
  }
];
...
const WagonRDetails = () => {
  ...
  if (!carData) {
    return <div className="min-h-screen bg-black flex items-center justify-center font-bold text-white uppercase tracking-tighter">Initializing Hatchback...</div>;
  }

  const details = {
    brand: carData.type.toUpperCase(),
    model: carData.models.toUpperCase(),
    category: "CITY HATCHBACK COLLECTION",
  ...
  const packagesData = [
    { id: 'city', title: 'LOCAL RIDE — 8HR 80KM', basePrice: 2200, extraKmRate: 12, extraHrRate: 150, hasExtras: true },
    { id: 'outstation', title: 'OUTSTATION — MIN 200KM / DAY', basePrice: 2800, extraKmRate: 13, extraHrRate: 250, hasExtras: true },
    { id: 'airport', title: 'AIRPORT PICKUP/DROP', basePrice: 800, extraKmRate: 0, extraHrRate: 0, hasExtras: false }
  ];
          ...
          <div className="flex items-center gap-4 md:gap-5">
            <div className="flex items-center text-white">
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-full border-[1.5px] border-white flex items-center justify-center">
                  <span className="font-bold text-[10px] md:text-xs tracking-tighter">CITY</span>
                </div>
            </div>
