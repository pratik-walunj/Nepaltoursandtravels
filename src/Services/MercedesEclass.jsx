...
// Placeholders: Aap apni actual Mercedes E-Class images yahan import karein
import mercedeseclassview from "../images/mercedeseclassview.png"; 
import mercedeseclassfrontview from "../images/mercedeseclassfrontview.png"; 
import mercedeseclassbackview from "../images/mercedeseclassbackview.png"; 
// Master Data specifically configured for Mercedes E-Class
const masterFleetData = [
  { 
    id: 101, 
    path: "mercedes-e-class", 
    type: "Mercedes-Benz", 
    models: "MERCEDES E CLASS", 
    seats: "5 SEATS", 
    bags: "3 BAGS", // Standard luxury sedan boot space
    pricePerKm: 45, // Luxury segment pricing
    rating: 4.9, 
    isAc: true, 
    img: mercedeseclassview,
    description: "The Mercedes-Benz E-Class is the epitome of executive luxury and sophisticated design. Preferred by corporate leaders and luxury travelers, this premium sedan offers an exceptionally quiet and smooth ride, thanks to its advanced air suspension and refined cabin insulation. Featuring plush leather seating, dual-zone climate control, and state-of-the-art infotainment, the E-Class ensures maximum comfort for both city commutes and long-distance journeys. Arrive at your destination in unparalleled style and elegance."
  }
];
...
const CabDetails = () => {
  ...
  // Structuring data for Mercedes E-Class
  const details = {
    ...
    images: [
      carData.img, 
      mercedeseclassfrontview, 
      mercedeseclassbackview
    ],
    features: [
      `${carData.seats}`,
      "AUTOMATIC", // Added automatic as per reference image
      "DIESEL", 
      `${carData.bags}`
    ]
  };

  // Mock Packages Data (Luxury Pricing)
  const packagesData = [
    {
      id: 'city',
