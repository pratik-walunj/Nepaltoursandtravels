...
// Assets - Replace these with your actual XUV 700 images
import xuv700Main from "../images/Mahindra-xuv.jpg"; 
import xuv700Front from "../images/Mahindra-xuv-front.jpg"; 
import xuv700Interior from "../images/Mahindra-xuv-back.jpg"; 

const masterFleetData = [
  { 
    id: 601, 
    path: "mahindra-xuv-700", 
    type: "Mahindra", 
    models: "Mahindra XUV 700", 
    seats: "7 SEATS", 
    bags: "4 BAGS", // Perfect for large groups and luggage
    pricePerKm: 20, // Standard premium SUV pricing
    rating: 5.0, // High rating based on source card
    isAc: true, 
    img: xuv700Main,
    description: "The Mahindra XUV 700 is a powerhouse of sophisticated technology, premium luxury, and dominant performance. As a top-tier SUV, it offers an exceptionally spacious 7-seater cabin, an integrated Mercedes-style dual-screen dashboard, and advanced driver assistance systems (ADAS) for unmatched safety. Whether navigating urban landscapes or executing long-distance highway cruises, the XUV 700 delivers a travel experience that is both technologically advanced and profoundly comfortable."
  }
];

const MahindraXuv700Details = () => {
  ...
  if (!carData) {
    return <div className="min-h-screen bg-black flex items-center justify-center font-bold text-white uppercase tracking-tighter">Calibrating ADAS...</div>;
  }
  ...
  const details = {
    ...
    images: [carData.img, xuv700Front, xuv700Interior],
    features: [ `${carData.seats}`, "ADAS SAFETY", "DUAL-AC", `${carData.bags}` ]
  };

  const packagesData = [
    { id: 'city', title: 'PREMIUM LOCAL — 8HR 80KM', basePrice: 4000, extraKmRate: 20, extraHrRate: 350, hasExtras: true },
    { id: 'outstation', title: 'HIGHWAY ELITE — MIN 300KM / DAY', basePrice: 14000, extraKmRate: 20, extraHrRate: 450, hasExtras: true },
    { id: 'airport', title: 'VIP GROUP TRANSFER', basePrice: 2500, extraKmRate: 0, extraHrRate: 0, hasExtras: false }
  ];
  ...
  return (
    <div className="font-sans bg-black min-h-screen pt-24 md:pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative selection:bg-gray-700 selection:text-white">
      ...
      {/* --- 1. MAIN VEHICLE DETAILS CARD (High-Contrast Theme) --- */}
      <div className="w-full max-w-[1000px] mx-auto bg-[#181818] rounded-[2.5rem] md:rounded-[3rem] p-6 md:p-10 shadow-2xl mb-8 border border-white/5">
        ...
        {/* --- IMAGE CONTAINER (Light Gray Pop Style) --- */}
      ...
      {/* --- PACKAGE SECTION (White Card Style) --- */}
...
export default MahindraXuv700Details;