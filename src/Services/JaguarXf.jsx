...
// Placeholders: Aap apni actual Jaguar XF images yahan import karein
import jaguarxfview from "../images/jaguarxfview.png"; // Replace with Jaguar XF image
import jaguarxffrontview from "../images/jaguarxffrontview.png"; // Replace with Jaguar XF image
import jaguarxfbackview from "../images/jaguarxfbackview.png"; // Replace with Jaguar XF image

// Master Data specifically configured for Jaguar XF
const masterFleetData = [
  { 
    ...
    seats: "5 SEATS", 
    bags: "3 BAGS", 
    pricePerKm: 50, // Executive luxury sedan pricing
    rating: 4.9, 
    isAc: true, 
    img: jaguarxfview,
    description: "The Jaguar XF is a masterpiece of British engineering, offering an exceptional blend of executive luxury, striking design, and dynamic performance. With its spacious and meticulously crafted cabin, premium leather upholstery, and advanced ride-handling dynamics, the XF provides a whisper-quiet, incredibly smooth journey. Perfect for corporate leaders, VIP airport transfers, and premium outstation travel, it ensures you arrive in absolute style and unrivaled comfort."
  }
];
...
const CabDetails = () => {
  ...
  useEffect(() => {
    const foundCar = masterFleetData.find(car => car.path === carName) || masterFleetData.find(car => car.id === 107);
    setCarData(foundCar);
  }, [carName]);
  ...
  // Structuring data for Jaguar XF
  const details = {
