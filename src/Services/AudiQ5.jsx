...
// Master Data specifically configured for Audi Q5
const masterFleetData = [
  { 
    ...
    models: "AUDI Q5", 
    seats: "5 SEATS", 
    bags: "4 BAGS", // Increased baggage capacity for mid-size SUV
    pricePerKm: 42, 
    rating: 4.9, 
    isAc: true, 
    // High-quality placeholder image for testing
    img: audiq5view,
    description: "The Audi Q5 is the perfect culmination of dynamic performance, striking design, and everyday versatility. As a premium mid-size SUV, it offers a remarkably spacious and refined cabin equipped with plush leather upholstery, a panoramic sunroof, and state-of-the-art acoustic insulation. Whether you are navigating urban landscapes or embarking on long-distance outstation journeys, the Audi Q5 delivers a commanding road presence, superior Quattro all-wheel-drive stability, and unmatched comfort for up to five passengers."
  }
];
...
const CabDetails = () => {
  ...
  // 1. Fetch Data UseEffect (Defaults to Audi Q5 if no path is given for testing)
  useEffect(() => {
    const foundCar = masterFleetData.find(car => car.path === carName) || masterFleetData.find(car => car.id === 103);
    setCarData(foundCar);
  }, [carName]);
  ...
  // Structuring data for Audi Q5
  const details = {
    brand: carData.type.toUpperCase(),
    model: carData.models.toUpperCase(),
    category: "LUXURY MID-SIZE SUV", // Updated Category for Q5
    driveType: "CHAUFFEUR DRIVEN",
    description: carData.description,
    images: [
      carData.img, // Side View
      audiq5frontview, // Placeholder: Front Angle View
      audiq5backview // Placeholder: Back Angle View
    ],
    features: [
      `${carData.seats}`,
  ...
  // Mock Packages Data (Adjusted pricing for a Mid-Size Luxury SUV)
  const packagesData = [
    {
      id: 'city',
