...
// Assets - Replace with your actual local image imports
...
const InnovaCrystaDetails = () => {
  ...
  if (!carData) {
    return <div className="min-h-screen bg-black flex items-center justify-center font-bold text-white uppercase tracking-tighter">Initializing Premium MPV...</div>;
  }
  ...
  const packagesData = [
    { id: 'city', title: 'LOCAL RIDE — 8HR 80KM', basePrice: 4500, extraKmRate: 22, extraHrRate: 350, hasExtras: true },
    { id: 'outstation', title: 'OUTSTATION — MIN 300KM / DAY', basePrice: 6600, extraKmRate: 24, extraHrRate: 0, hasExtras: true },
    { id: 'airport', title: 'AIRPORT LUXURY TRANSFER', basePrice: 2200, extraKmRate: 0, extraHrRate: 0, hasExtras: false }
  ];
          ...
          <div className="flex items-center gap-4 md:gap-5">
            <div className="flex items-center text-white">
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-full border-[1.5px] border-white flex items-center justify-center">
                  <span className="font-bold text-[10px] md:text-xs tracking-tighter text-white">7-STR</span>
                </div>
            </div>
