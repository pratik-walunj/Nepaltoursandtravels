...
// Placeholders: Aap apni actual Mercedes C-Class images yahan import karein
import mercedescclassbackview from "../images/mercedescclassbackview.png"; 
import mercedescclassfrontview from "../images/mercedescclassfrontview.png"; 
import mercedescclassview from "../images/mercedescclassview.png"; 
// Master Data specifically configured for Mercedes C-Class
const masterFleetData = [
  { 
    id: 102, 
    path: "mercedes-c-class", 
    type: "Mercedes-Benz", 
    models: "MERCEDES C CLASS", 
    seats: "5 SEATS", 
    bags: "3 BAGS", 
    pricePerKm: 40, // Slightly more affordable than E-Class
    rating: 4.8, 
    isAc: true, 
    img: mercedescclassview,
    description: "The Mercedes-Benz C-Class perfectly blends sporty dynamics with modern luxury. Ideal for corporate travel, stylish city drives, and premium airport transfers, this sleek sedan features a tech-forward cabin with ambient lighting, premium leather upholstery, and an advanced infotainment system. Experience agile handling, a whisper-quiet ride, and the unmistakable prestige of the Mercedes-Benz badge, making every journey an absolute pleasure."
  }
];
...
const CabDetails = () => {
  ...
  // Structuring data for Mercedes C-Class
  const details = {
    ...
    images: [
      carData.img, 
      mercedescclassfrontview, 
      mercedescclassbackview
    ],
    features: [
      `${carData.seats}`,
      "AUTOMATIC",
  ...
  // Mock Packages Data (C-Class Pricing)
  const packagesData = [
    {
      id: 'city',
