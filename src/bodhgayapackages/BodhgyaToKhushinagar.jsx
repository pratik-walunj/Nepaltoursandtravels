...
import khushinagarbanner from "../images/khushinagarbanner.png"
import vaishalipillarkhushinagar from "../images/vaishalipillarkhushinagar.jpg"
// --- BODH GAYA TO KUSHINAGAR MOCK DATA ---
const packageData = {
  title: "Path to Nirvana: Bodh Gaya to Kushinagar Tour",
  rating: 4.9,
  reviews: 485,
  ...
  images: [
    ...
    "https://images.unsplash.com/photo-1555881400-74d7acaacd8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", // Stupa / Monastery vibe
    vaishalipillarkhushinagar  // Ancient Architecture
  ],
  itinerary: [
    {
      day: 1,
      ...
      description: "Arrive at Gaya Airport or Railway Station. Our representative will warmly welcome you and transfer you to your hotel in Bodh Gaya. After resting, visit the highly revered UNESCO World Heritage Mahabodhi Temple, the exact spot where Lord Buddha attained enlightenment under the Bodhi Tree. Later, explore the 80-foot Great Buddha Statue and various beautifully crafted international monasteries. Overnight stay in Bodh Gaya."
    },
    {
      day: 2,
      title: "Bodh Gaya to Kushinagar via Vaishali",
      image: vaishalipillarkhushinagar,
      description: "After an early breakfast, check out and begin your drive towards Kushinagar. En route, make a spiritual stop at Vaishali, an ancient city where Lord Buddha preached his last sermon. Visit the magnificent Ashoka Pillar, Ananda Stupa, and the Abhishek Pushkarini (Coronation Tank). Continue your scenic journey into Uttar Pradesh to reach Kushinagar. Upon arrival, check into your hotel and relax. Overnight stay in Kushinagar."
    },
    {
      day: 3,
      title: "Kushinagar Sightseeing & Departure via Gorakhpur",
      image: "https://images.unsplash.com/photo-1555881400-74d7acaacd8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "After breakfast, head out to explore Kushinagar, the final resting place of Lord Buddha. Visit the Mahaparinirvana Temple, which houses the iconic 6-meter-long Reclining Buddha statue representing his final passing. Next, visit the Ramabhar Stupa, the cremation site of Lord Buddha, and the Mata Kaur Shrine. After completing the spiritual tour, you will be driven to Gorakhpur Airport or Railway Station for your onward journey."
    }
  ],
  highlights: [
    "Meditate under the sacred Bodhi Tree at the Mahabodhi Temple.",
    "Visit the ancient city of Vaishali and the historic Ashoka Pillar.",
    "Pay your respects at the Mahaparinirvana Temple in Kushinagar.",
    "Witness the Ramabhar Stupa, the cremation site of Lord Buddha.",
    "Seamless inter-state transfers across the major Buddhist Circuit."
  ],
  transfer: [
    "Pick-up from Gaya Airport / Railway Station.",
    "Inter-city transfers (Bodh Gaya - Vaishali - Kushinagar) by private AC vehicle.",
  ...
  sightseeing: [
    ...
    "Vaishali: Ashoka Pillar, Ananda Stupa, Abhishek Pushkarini.",
    "Kushinagar: Mahaparinirvana Temple (Reclining Buddha), Ramabhar Stupa."
  ],
  accommodation: [
    "Bodh Gaya: 1 Night in a 3-star or 4-star premium category hotel.",
    "Kushinagar: 1 Night in a 3-star or 4-star premium category hotel."
  ],
  meals: [
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "All transfers and sightseeing excursions by dedicated AC vehicle.",
      "Experienced local driver-cum-guide.",
      "Driver allowance, parking, and inter-state toll taxes."
    ],
    exclusions: [
      "Train/Airfare to reach Gaya or depart from Gorakhpur.",
      "Lunches and Dinners.",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Bodh Gaya to Kushinagar Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md">
                <Users size={14} className="mr-1" /> Buddhist Circuit
              </div>
              ...
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Kushinagar Stupa" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Vaishali Pillar" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> BUDDHA10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Buddhist Circuit Tours*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> UPBIHAR26</div>
...
export default BodhGayaToKushinagar;