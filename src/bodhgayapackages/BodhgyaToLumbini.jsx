...
import sunauli from "../images/sunauli.webp"
import lumbin from "../images/lumbin.jpeg"
// --- BODH GAYA TO LUMBINI (NEPAL) MOCK DATA ---
const packageData = {
  title: "The Buddha's Footsteps: Bodh Gaya to Lumbini Tour",
  rating: 4.9,
  reviews: 742,
  ...
  images: [
    ...
    "https://images.unsplash.com/photo-1555881400-74d7acaacd8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", // Lumbini Monastery vibe
    "https://images.unsplash.com/photo-1544735716-392fe2489ffa?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"  // Peaceful landscape
  ],
  itinerary: [
    {
      day: 1,
      title: "Arrival in Bodh Gaya & The Seat of Enlightenment",
      image: "https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Arrive at Gaya Airport or Railway Station. Our representative will meet you and transfer you to your hotel in Bodh Gaya. Begin your spiritual journey at the UNESCO World Heritage Mahabodhi Temple. Sit in quiet meditation beneath the sacred Bodhi Tree, where Lord Buddha attained supreme enlightenment. Later, visit the towering 80-foot Great Buddha Statue and explore the serene Thai and Japanese Monasteries. Overnight stay in Bodh Gaya."
    },
    {
      day: 2,
      title: "Drive to Lumbini (Nepal) via the Sunauli Border",
      image: sunauli,
      description: "After an early breakfast, embark on a long but highly rewarding scenic drive from Bihar towards the Indo-Nepal border at Sunauli. After completing the smooth border crossing formalities, enter the beautiful country of Nepal and proceed directly to Lumbini, the birthplace of Lord Buddha. Check into your hotel, relax after the journey, and enjoy a peaceful evening. Overnight stay in Lumbini."
    },
    {
      day: 3,
      title: "Lumbini Sacred Garden & Monastic Zone Tour",
      image: lumbin,
      description: "After breakfast, step into the Sacred Garden. Visit the world-famous Maya Devi Temple, marking the exact spot where Queen Maya Devi gave birth to Siddhartha Gautama. See the historic Ashoka Pillar erected in 249 BC and the holy Puskarni Pond. In the afternoon, hire an eco-rickshaw or bicycle to explore the massive East and West Monastic Zones, featuring stunning architectural marvels like the World Peace Pagoda, the Royal Thai Monastery, and the Golden Temple of Myanmar. Overnight stay in Lumbini."
    },
    {
      day: 4,
      title: "Departure via Gorakhpur or Gaya",
      image: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "After a serene morning and a hearty breakfast, check out from your hotel in Lumbini. We will drive back to the Sunauli border, cross back into India, and proceed to your chosen drop-off point (either Gorakhpur Airport/Railway Station or Gaya). Conclude your ultimate Buddhist pilgrimage with a lifetime of divine memories."
    }
  ],
  highlights: [
    "Meditate at the Mahabodhi Temple where Buddha attained Enlightenment.",
    "Cross the international Indo-Nepal border for a seamless spiritual circuit.",
    "Visit the exact birthplace of Lord Buddha at the Maya Devi Temple.",
    "Explore the magnificent international monasteries and World Peace Pagoda.",
    "Comfortable, hassle-free private transfers across two countries."
  ],
  transfer: [
    "Pick-up from Gaya Airport / Railway Station.",
    "Cross-border permit and customs assistance at the Sunauli border.",
    "All inter-city and international transfers by private AC vehicle.",
    "Drop-off at Gorakhpur or Gaya Airport / Railway Station."
  ],
  sightseeing: [
    "Bodh Gaya: Mahabodhi Temple, Bodhi Tree, Great Buddha Statue.",
    "Lumbini: Maya Devi Temple, Ashoka Pillar, Holy Pond.",
    "Lumbini: World Peace Pagoda, East and West Monastic Zones."
  ],
  accommodation: [
    "Bodh Gaya: 1 Night in a 3-star or 4-star premium category hotel.",
    "Lumbini (Nepal): 2 Nights in a 3-star or 4-star peaceful premium hotel."
  ],
  meals: [
    "Daily buffet breakfast at the hotels in Bodh Gaya and Lumbini.",
    "Welcome drink upon arrival at both hotels.",
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "Nepal border entry tax, road permits, and customs clearance.",
      "Experienced Hindi/English speaking driver-cum-guide."
    ],
    exclusions: [
      "Train/Airfare to reach Gaya or depart from Gorakhpur/Gaya.",
      "Lunches and Dinners.",
      "Monument entrance fees and eco-rickshaw rentals in Lumbini.",
      "Travel, Medical Insurance, and Visa fees (if applicable for non-Indians).",
      "Personal expenses (laundry, tips, telephone, camera fees)."
    ]
  }
};
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Bodh Gaya to Lumbini Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md">
                <Users size={14} className="mr-1" /> Cross-Border Circuit
              </div>
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Bodh Gaya Temple" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Lumbini Monastery" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Nepal Landscape" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                ...
                <span className="text-xs font-semibold text-gray-700">Hotels</span>
              </div>
              <div className="flex flex-col items-center justify-center min-w-[80px]">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +500</strong><br/>Holiday Reward points on this booking</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> LUMBINI10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Nepal Border Tours*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
...
export default BodhGayaToLumbini;