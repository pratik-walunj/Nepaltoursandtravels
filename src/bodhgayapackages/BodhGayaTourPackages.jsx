...
const packagesData = [
  ...
  },
  {
    ...
    region: "Short Drive",
    image: Rajgir,
    destinations: "Bodh Gaya (1N) → Rajgir/Nalanda (1N) → Gaya Drop",
  ...
  {
    id: 3,
    title: "BodhGaya → Nalanda",
    region: "Ancient Wisdom",
    image: Nalanda,
    destinations: "Bodh Gaya (1N) → Nalanda",
  ...
  },
  {
    ...
    image: Patna,
    destinations: "Bodh Gaya (1N) → Patna (1N) → Patna Drop",
    duration: "3 Days / 2 Night",
    daysValue: 2,
    originalPrice: "₹....",
    discountedPrice: "₹....",
  ...
  {
    id: 5,
    title: "Bodhgaya → Khushinagar",
    region: "Mahaparinirvana",
    image: Kushinagar,
    destinations: "Bodh Gaya (1N) → Vaishali → Kushinagar (1N) → Gorakhpur Drop",
  ...
  {
    id: 6,
    title: "Bodhgaya → Lumbini",
    region: "Lumbini Border",
    image: Nepal,
    destinations: "Bodh Gaya (1N) → Sunauli Border → Lumbini (2N) ",
