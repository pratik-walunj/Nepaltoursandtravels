...
import patnabanner from "../images/patnabanner.png"
import patnastupa from "../images/patnastupa.jpg"
import patnasahib from "../images/patnasahib.avif"
// --- BODH GAYA TO PATNA MOCK DATA ---
const packageData = {
  title: "Heritage & Divinity: Bodh Gaya to Patna Tour",
  rating: 4.7,
  reviews: 512,
  ...
  images: [
    ...
    patnastupa, // Stupa/Park
    patnasahib  // Heritage Architecture
  ],
  itinerary: [
    {
      day: 1,
      title: "Arrival in Bodh Gaya & Spiritual Exploration",
      image: "https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Arrive at Gaya Airport or Railway Station. Our representative will meet you and transfer you to your hotel in Bodh Gaya. In the afternoon, visit the UNESCO World Heritage Mahabodhi Temple. Spend peaceful moments meditating under the sacred Bodhi Tree where Prince Siddhartha attained enlightenment. Later, visit the 80-foot Great Buddha Statue and the beautifully crafted Japanese and Thai Monasteries. Overnight stay in Bodh Gaya."
    },
    {
      day: 2,
      title: "Drive to Patna & City Heritage Tour",
      image: patnastupa,
      description: "After breakfast, check out and embark on a comfortable drive to Patna, the ancient capital of Pataliputra (approx. 3-4 hours). Upon arrival, check into your hotel. In the afternoon, visit the iconic Golghar, a massive granary built by the British, offering a panoramic view of the city and the River Ganges. Later, visit the Bihar Museum, which houses a world-class collection of ancient Indian artifacts. Overnight stay in Patna."
    },
    {
      day: 3,
      title: "Takht Sri Patna Sahib, Buddha Smriti Park & Departure",
      image: patnasahib,
      description: "After breakfast, visit Takht Sri Harmandir Ji Patna Sahib, a highly revered Gurudwara built in remembrance of the birthplace of Guru Gobind Singh Ji. Experience the spiritual calmness and partake in the Langar (optional). Next, visit the beautifully landscaped Buddha Smriti Park and the Karuna Stupa in the heart of the city. After completing the sightseeing, you will be transferred to Patna Airport or Railway Station for your onward journey."
    }
  ],
  highlights: [
    "Meditate under the sacred Bodhi Tree at the Mahabodhi Temple.",
    "Pay respects at Takht Sri Patna Sahib, the birthplace of Guru Gobind Singh Ji.",
    "Climb the iconic Golghar for a panoramic view of Patna and the Ganges.",
    "Explore the modern and artifact-rich Bihar Museum.",
    "Seamless inter-city transfer from Bodh Gaya to Patna."
  ],
  transfer: [
    "Pick-up from Gaya Airport / Railway Station.",
    "Bodh Gaya to Patna inter-city transfer by private AC vehicle.",
    "Drop-off at Patna Airport / Railway Station.",
  ...
  sightseeing: [
    ...
    "Patna: Takht Sri Patna Sahib, Golghar, Bihar Museum.",
    "Patna: Buddha Smriti Park and Karuna Stupa."
  ],
  accommodation: [
    "Bodh Gaya: 1 Night in a 3-star or 4-star premium category hotel.",
    "Patna: 1 Night in a 3-star or 4-star premium category hotel."
  ],
  meals: [
  ...
  inclusionExclusions: {
    ...
    exclusions: [
      "Train/Airfare to reach Gaya or depart from Patna.",
      "Lunches and Dinners.",
      "Monument and Museum entrance fees (e.g., Bihar Museum).",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Bodh Gaya to Patna Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md">
                <Users size={14} className="mr-1" /> Heritage & City Tour
              </div>
              ...
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Patna Stupa" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Heritage Architecture" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +250</strong><br/>Holiday Reward points on this booking</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> PATNA10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Patna Heritage Tours*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> BIHAR26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto ₹2000 off on Credit Cards*</p>
                </div>
              </div>
            </div>
...
export default BodhGayaToPatna;