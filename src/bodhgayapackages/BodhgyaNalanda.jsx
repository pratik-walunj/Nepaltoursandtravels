...
import nalandabanner from "../images/nalandabanner.png"
// --- BODH GAYA TO NALANDA MOCK DATA ---
const packageData = {
  title: "Echoes of Enlightenment: Bodh Gaya to Nalanda Tour",
  rating: 4.8,
  reviews: 380,
  duration: "1 Night 2 Days",
  route: "Bodh Gaya (1N) → Nalanda → Rajgir → Bodh Gaya/Gaya Drop",
  originalPrice: 10500,
  basePriceAdult: 7500,
  basePriceChildWithBed: 5000,
  basePriceChildWithoutBed: 3500,
  topBannerImage: nalandabanner, 
  images: [
    Nalanda, // Bodh Gaya Temple
    rajgirpawapuri, // Ancient Architecture/Ruins
    nalandaruins // Stupa/Peace Pagoda
  ],
  itinerary: [
    {
      day: 1,
      title: "Arrival in Bodh Gaya & Spiritual Sightseeing",
      image: "https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Arrive at Gaya Airport or Railway Station. Our representative will meet you and transfer you to your hotel in Bodh Gaya. After freshening up, head out to visit the UNESCO World Heritage Mahabodhi Temple. Spend time meditating under the sacred Bodhi Tree where Prince Siddhartha attained enlightenment. Later, visit the majestic 80-foot Great Buddha Statue, the Thai Temple, and the Japanese Monastery. Overnight stay in Bodh Gaya."
    },
    {
      day: 2,
      title: "Excursion to Nalanda & Rajgir, Departure",
      image: rajgirpawapuri,
      description: "After an early breakfast, check out from the hotel and drive towards Nalanda (approx. 2.5 hours). Explore the fascinating ruins of the ancient Nalanda University, one of the greatest centers of learning in the ancient world. Visit the Nalanda Archaeological Museum and the Xuanzang Memorial Hall. After lunch, proceed to nearby Rajgir to see the Vishwa Shanti Stupa via the ropeway and Venu Van. By evening, you will be driven back to Gaya Airport or Railway Station for your onward journey."
    }
  ],
  highlights: [
    "Experience the spiritual aura of the Mahabodhi Temple and Bodhi Tree.",
    "Walk through the massive brick ruins of the ancient Nalanda University.",
    "Discover a rich collection of Buddhist artifacts at the Nalanda Museum.",
    "Enjoy a scenic ropeway ride to the Peace Pagoda in Rajgir.",
    "Read More"
  ],
  transfer: [
    "Pick-up and drop-off from Gaya Airport or Railway Station.",
    "Bodh Gaya to Nalanda & Rajgir round-trip by private AC vehicle.",
    "All toll taxes, state taxes, parking fees, and driver allowances included."
  ],
  sightseeing: [
    "Bodh Gaya: Mahabodhi Temple, Bodhi Tree, 80-ft Great Buddha Statue.",
    "Nalanda: Ancient University Ruins, Xuanzang Memorial, Archaeological Museum.",
    "Rajgir: Vishwa Shanti Stupa (Peace Pagoda), Venu Van."
  ],
  accommodation: [
    "Bodh Gaya: 1 Night in a 3-star or 4-star premium category hotel."
  ],
  meals: [
    "1 Buffet Breakfast at the hotel in Bodh Gaya.",
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "Experienced local guide for the Nalanda University ruins.",
      "Driver allowance, parking, and toll taxes."
    ],
    exclusions: [
      "Train/Airfare to reach Gaya.",
      "Lunches and Dinners.",
      "Monument, Museum entrance fees, and Rajgir Ropeway tickets.",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Bodh Gaya to Nalanda Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md">
                <Users size={14} className="mr-1" /> Educational & Spiritual Tour
              </div>
              ...
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Nalanda Ruins" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Rajgir Stupa" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> NALANDA10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Nalanda Excursions*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
...
export default BodhGayaToNalanda;