  ...
  return (
    ...
    <div className="w-full font-sans bg-gray-50">
      ...
      <section className="relative w-full h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-20 text-center px-4 w-full max-w-5xl mx-auto mt-12 md:mt-16">
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-md text-white border border-white/40 text-xs md:text-sm font-bold uppercase tracking-widest mb-4 md:mb-6">
            <PlayCircle size={16} className="text-orange-400" />
            Discover The Nepal
          </span>
          ...
          <p className="text-base sm:text-lg md:text-2xl text-gray-100 mb-8 md:mb-10 max-w-3xl mx-auto font-medium px-2">
            From the peak of Mount Everest to the peaceful lakes of Pokhara. Your ultimate Himalayan adventure starts here.
          </p>
          
          {/* SEARCH BAR (Dropdown Removed) */}
          <div className="bg-white p-2 md:p-3 rounded-2xl md:rounded-full flex flex-col md:flex-row items-center justify-between border-4 border-white/20 max-w-3xl mx-auto space-y-2 md:space-y-0 text-left shadow-2xl">
