...
import { 
  ...
  Camera, Bus, Award, Users, Landmark 
} from 'lucide-react';

// --- BHUTAN: THIMPHU CAPITAL HEART PACKAGE DATA ---
const packageData = {
  ...
  images: [
    "https://nepaltoursandtravels.com/wp-content/uploads/2025/12/Thimphu.jpg", // Buddha Dordenma
    buddhadordenma, // Thimphu City
    dzong  // Tashichho Dzong
  ],
  itinerary: [
    {
      day: 1,
      title: "Arrival at Paro & Drive to Thimphu",
      image: "https://nepaltoursandtravels.com/wp-content/uploads/2025/12/Thimphu.jpg",
      description: "Arrival at Paro International Airport. Meet our representative and enjoy a scenic 1.5-hour drive to Thimphu, the world's only capital without traffic lights. Check-in to the hotel and spend the evening exploring Norzin Lam (main street). Overnight stay in Thimphu."
    },
    {
      day: 2,
      title: "Full Day Thimphu Exploration",
      image: buddhadordenma,
      description: "Visit the massive Buddha Dordenma (Buddha Point), the National Memorial Chorten, and the Motithang Takin Preserve to see Bhutan's national animal. In the afternoon, explore the majestic Tashichho Dzong and the Authentic Bhutanese Crafts Bazaar. Overnight stay in Thimphu."
    },
    {
      day: 3,
      title: "Thimphu to Paro & Departure",
      image: paroairport,
      description: "After an early breakfast, drive back to Paro. If time permits, visit the Kyichu Lhakhang before being transferred to the airport for your onward flight."
    }
  ],
  highlights: [
    "3 Days quick cultural immersion in the heart of Bhutan's capital.",
    "Visit to the 169ft tall bronze Buddha Dordenma statue.",
    "Evening walk through Thimphu's vibrant local markets and cafes.",
    "Seamless private transfers from Paro Airport and back.",
    "Read More"
  ],
  transfer: [
    "Private AC SUV/Coaster for all transfers.",
    "Paro Airport pickup and drop-off included.",
    "All local sightseeing in Thimphu as per itinerary.",
    "Professional English-speaking driver-cum-guide."
  ],
  sightseeing: [
    "Thimphu: Buddha Point, Memorial Chorten, Tashichho Dzong.",
    "Culture: Folk Heritage Museum, Postal Museum, Crafts Bazaar."
  ],
  accommodation: [
    "Thimphu: 2 Nights in a 3-star or 4-star boutique city hotel."
  ],
  meals: [
    "Daily buffet breakfast at the hotel.",
    "Welcome Bhutanese tea and snacks upon arrival.",
  ...
  inclusionExclusions: {
    inclusions: [
      ...
      "Bhutan Entry Permits and processing."
    ],
    exclusions: [
      "International Airfare.",
      "Sustainable Development Fee (SDF) for non-Indians.",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Thimphu Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-orange-600 text-xs font-bold flex items-center shadow-md"><Landmark size={14} className="mr-1" /> Capital Heart</div>
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Buddha Point" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden"><img src={packageData.images[1]} alt="City" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Dzong" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  <div className="w-6 h-6 bg-orange-100 text-orange-600 rounded mr-2 flex items-center justify-center font-bold text-[10px]">HR</div>
                  <span><strong className="text-gray-800 text-sm">Earn +850</strong><br/>Holiday Reward points</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> CAPITAL26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 7K off on Thimphu Tours*</p>
                </div>
              </div>
            </div>
          </div>
...
export default ThimphuCapitalTour;