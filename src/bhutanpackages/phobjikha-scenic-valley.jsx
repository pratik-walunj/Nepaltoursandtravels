...
import PhobjikhaValley from "../images/Phobjikha Valley.jpg"
import GangteyMonastery from "../images/Gangtey-Monastery.jpg"
import blackneckedcranes from "../images/blackneckedcranes.jpg"
...
import dzong from "../images/dzong.webp"
import ParoTaktsang from "../images/Paro Taktsang.jpg"
import goembanunnery from "../images/goembanunnery.webp"
...
import { 
  ...
  Camera, Bus, Award, Users, Bird 
} from 'lucide-react';
import { fromJSON } from 'postcss';

// --- BHUTAN: PHOBJIKHA SCENIC VALLEY PACKAGE DATA ---
const packageData = {
  ...
  images: [
     PhobjikhaValley, // Valley View
     GangteyMonastery, // Gangtey Monastery
    blackneckedcranes  // Black Necked Crane Habitat
  ],
  itinerary: [
    {
      day: 1,
      ...
      description: "Arrival at Paro Airport. Scenic drive to Thimphu. Visit the Memorial Chorten and the local market. Overnight stay in Thimphu."
    },
    {
      day: 2,
      title: "Thimphu Sightseeing",
      image: buddhadordenma,
      description: "Explore Buddha Point, Folk Heritage Museum, and Tashichho Dzong. Evening free for shopping. Overnight stay in Thimphu."
    },
    {
      day: 3,
      title: "Thimphu to Punakha via Dochula Pass",
      image: himalayan,
      description: "Stop at Dochula Pass for panoramic Himalayan views. Visit Chimi Lhakhang (Fertility Temple) en route. Overnight stay in Punakha."
    },
    {
      day: 4,
      title: "Punakha to Phobjikha Valley",
      image:  GangteyMonastery,
      description: "Drive to the glacial valley of Phobjikha. Visit the majestic Gangtey Monastery. Evening walk through the marshy valley floor. Overnight stay in Phobjikha."
    },
    {
      day: 5,
      title: "Nature Trail & Crane Center",
      image: blackneckedcranes,
      description: "Enjoy the Gangtey Nature Trail hike. Visit the Black-Necked Crane Information Centre to learn about these rare winter visitors. Overnight stay in Phobjikha."
    },
    {
      day: 6,
      title: "Phobjikha to Wangdue Phodrang",
      image: WangduePhodrangDzong,
      description: "Drive back towards Wangdue. Visit the newly rebuilt Wangdue Phodrang Dzong. Overnight stay in Wangdue."
    },
    {
      day: 7,
      title: "Return to Paro",
      image: dzong,
      description: "Drive back to Paro. Visit the National Museum and Paro Dzong. Free evening to explore Paro town. Overnight stay in Paro."
    },
    {
      day: 8,
      title: "Tiger's Nest Hike",
      image: ParoTaktsang,
      description: "Full day excursion to Taktsang Lhakhang (Tiger's Nest). The most iconic spiritual site in Bhutan. Overnight stay in Paro."
    },
    {
      day: 9,
      title: "Chelala Pass Excursion",
      image: goembanunnery,
      description: "Drive to the highest motorable pass in Bhutan, Chelala Pass. Enjoy views of Mt. Jomolhari. Visit Kila Goemba Nunnery. Overnight stay in Paro."
    },
    {
      day: 10,
  ...
  highlights: [
    "10 Days comprehensive tour covering Central Bhutan's natural beauty.",
    "Specialized visit to the rare Black-Necked Crane habitat.",
    "Hiking the Gangtey Nature Trail and the Tiger's Nest.",
    "Complete sustainable travel with all permits and luxury AC vehicles.",
    "Read More"
  ],
  transfer: [
    "Private SUV or Luxury Van for all inter-city transfers.",
    "Airport pickup and drop-off in Paro.",
    "All fuel, toll, and inner-line permit costs included.",
    "Experienced guide-cum-driver for high mountain passes."
  ],
  sightseeing: [
    "Phobjikha: Gangtey Monastery, Nature Trail, Crane Centre.",
    "Paro: Tiger's Nest, Museum, Dzongs, Chelala Pass.",
    "Thimphu: Buddha Point, Chorten, Museums."
  ],
  accommodation: [
    "Thimphu: 2 Nights in a 4-star boutique hotel.",
    "Punakha/Wangdue: 2 Nights in a Premium Riverside Resort.",
    "Phobjikha: 2 Nights in a traditional eco-lodge.",
    "Paro: 3 Nights in a Luxury Spa Resort."
  ],
  meals: [
    "Daily buffet breakfast at all hotels.",
    "Traditional Bhutanese lunch at a farmhouse.",
    "24/7 bottled water and snacks provided in the vehicle."
  ],
  inclusionExclusions: {
    inclusions: [
      "Sustainable Development Fee (SDF) included.",
      "Professional English-speaking Bhutanese guide.",
      "All entrance fees to monuments and Dzongs.",
...
const vehicleData = [
  { name: "Luxury SUV (Prado/Landcruiser)", capacity: 4 },
  { name: "Hiace Van (Deluxe)", capacity: 8 },
  { name: "Tempo Traveller (14 Seater)", capacity: 14 },
  { name: "Coaster Bus (22 Seater)", capacity: 22 }
];
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Phobjikha Banner" className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          <div className="w-full lg:w-[68%]">
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-purple-600 text-xs font-bold flex items-center shadow-md"><Bird size={14} className="mr-1" /> Phobjikha Region</div>
              <div className="w-full md:w-2/3 h-full overflow-hidden"><img src={packageData.images[0]} alt="Scenic Valley" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden"><img src={packageData.images[1]} alt="Monastery" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group"><img src={packageData.images[2]} alt="Crane" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /></div>
              </div>
            </div>

            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              {[{ icon: <BedDouble size={24} />, label: "Hotel", color: "bg-purple-500" }, { icon: <Utensils size={24} />, label: "Meals", color: "bg-green-500" }, { icon: <Camera size={24} />, label: "Sightseeing", color: "bg-pink-600" }, { icon: <Bus size={24} />, label: "Transfer", color: "bg-blue-500" }, { icon: <Award size={24} />, label: "Highlights", color: "bg-orange-400" }].map((item, i) => (
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  <div className="w-6 h-6 bg-purple-100 text-purple-600 rounded mr-2 flex items-center justify-center font-bold text-[10px]">HR</div>
                  <span><strong className="text-gray-800 text-sm">Earn +2500</strong><br/>Holiday Reward points</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> SCENIC2026</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto 15K off on Central Bhutan Tours*</p>
                </div>
              </div>
            </div>
          </div>
...
export default PhobjikhaValleyTour;