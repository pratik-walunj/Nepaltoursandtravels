...
const packageData = {
  title: "Mystic Mustang: Gorakhpur to Muktinath Tour",
  rating: 4.9,
  reviews: 612,
  ...
  highlights: [
    ...
    "Thrilling off-road 4WD drive through the Kali Gandaki Gorge.",
  ...
  transfer: [
    ...
    "Pokhara to Jomsom/Muktinath by specialized 4WD Jeep (Scorpio/Bolero).",
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              ...
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                ...
                <span className="text-xs font-semibold text-gray-700">4WD Transfer</span>
              </div>
              <div className="flex flex-col items-center justify-center min-w-[80px]">
