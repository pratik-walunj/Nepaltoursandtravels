...
import jbv from "../images/jbv.png"

// --- GORAKHPUR TO CHITWAN MOCK DATA ---
const packageData = {
  ...
  images: [
    ...
    jbv, // Elephant/Safari
    reptiriver  // Landscape/River
  ],
  itinerary: [
    {
      day: 1,
      title: "Pickup from Gorakhpur & Drive to Chitwan",
      image: gorakhpur,
      description: "Arrive at Gorakhpur Railway Station or Airport. Our representative will pick you up and drive towards the Sunauli border. After completing the border crossing formalities, enjoy a scenic drive to Chitwan National Park. Check into your jungle resort, relax, and in the evening, enjoy a traditional Tharu Cultural Stick Dance performance. Overnight stay in Chitwan."
    },
    {
      day: 2,
      title: "Full Day Jungle Safari & Wildlife Activities",
      image: reptiriver,
      description: "Get ready for an adventurous day! After breakfast, head deep into the forest for a thrilling Jeep Safari to spot the One-Horned Rhinoceros, deer, and if you're lucky, the Royal Bengal Tiger. Later, enjoy a peaceful Canoe ride on the Rapti River, where you can spot crocodiles and exotic birds. Visit the Elephant Breeding Centre in the late afternoon. Overnight stay in Chitwan."
    },
    {
      day: 3,
      title: "Jungle Walk, Bird Watching & Village Tour",
      image:jbv,
      description: "Wake up early for a guided Jungle Nature Walk and Bird Watching tour to explore the rich biodiversity of the park on foot. Return to the resort for breakfast. In the afternoon, take a guided tour of the local Tharu village to understand their unique lifestyle and mud-house architecture. Spend the evening relaxing by the riverbank watching a mesmerizing sunset. Overnight stay in Chitwan."
    },
    {
      day: 4,
      title: "Drive Back to Gorakhpur & Departure",
      image: gorakhpur,
      description: "After a hearty breakfast, check out from your jungle resort. Begin your comfortable return journey towards the Indian border. Cross the Sunauli border and proceed straight to Gorakhpur. You will be dropped off at Gorakhpur Railway Station or Airport for your onward journey with thrilling wildlife memories."
    }
  ],
  highlights: [
    "Convenient pick-up and drop-off directly from Gorakhpur Station/Airport.",
    "Thrilling Jeep Safari deep inside Chitwan National Park.",
    "Experience the local culture with a traditional Tharu Dance Show.",
    "Peaceful Canoe ride on the Rapti River to spot crocodiles.",
    "Read More"
  ],
  transfer: [
  ...
  sightseeing: [
    "Chitwan: Jungle Safari, Canoe Ride on Rapti River.",
    "Chitwan: Elephant Breeding Centre Visit.",
    "Chitwan: Guided Nature Walk and Bird Watching.",
    "Chitwan: Tharu Village Tour & Cultural Dance Show."
  ],
  accommodation: [
    "Chitwan: 3 Nights in a 3-star or 4-star category premium Jungle Resort."
  ],
  meals: [
    "All Meals Included (Breakfast, Lunch, and Dinner) during the Chitwan stay.",
    "Welcome drink upon arrival at the jungle resort.",
    "1 bottle of packaged drinking water per person per day during travel."
  ],
  inclusionExclusions: {
    inclusions: [
      "Accommodation on a twin-sharing basis.",
      "All meals (AP Plan - Breakfast, Lunch, Dinner) at the resort.",
      "All transfers and sightseeing by dedicated AC vehicle.",
      "National Park entry permits and activity fees.",
      "Experienced local nature guide for jungle activities."
    ],
    exclusions: [
      ...
      "Any activities not explicitly mentioned in inclusions."
    ]
  }
};
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              <div className="absolute top-4 left-4 z-10 bg-white px-3 py-1 rounded text-red-600 text-xs font-bold flex items-center shadow-md">
                <Users size={14} className="mr-1" /> Wildlife Tour
              </div>
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Chitwan Rhino" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                <div className="flex-1 overflow-hidden">
                  <img src={packageData.images[1]} alt="Chitwan Safari" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Rapti River" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 mb-10 pb-6 border-b border-gray-200 overflow-x-auto hide-scrollbar">
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                ...
                <span className="text-xs font-semibold text-gray-700">Resort</span>
              </div>
              <div className="flex flex-col items-center justify-center min-w-[80px]">
              ...
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                ...
                <span className="text-xs font-semibold text-gray-700">Safari</span>
              </div>
              <div className="flex flex-col items-center justify-center min-w-[80px]">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <div className="bg-[#f9f9f9] border border-gray-100 rounded-md py-3 px-4 flex items-center justify-center mb-5">
                <div className="text-left flex items-center text-xs text-gray-600">
                  ...
                  <span><strong className="text-gray-800 text-sm">Earn +450</strong><br/>Holiday Reward points on this booking</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> WILDLIFE10</div>
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Chitwan Safari Tours*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
