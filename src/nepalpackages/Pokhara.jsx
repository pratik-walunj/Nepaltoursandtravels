...
// import sarangkot from "../images/sarangkot.png"
// import { 
...
// // --- GORAKHPUR TO POKHARA MOCK DATA ---
// const packageData = {
...
//     pokhara, // Lumbini/Temple vibe
//     pokhara2 // Mountains
//   ],
//   itinerary: [
//     {
//       day: 1,
//       title: "Pickup from Gorakhpur & Drive to Pokhara via Lumbini",
//       image: gorakhpur,
//       description: "Arrive at Gorakhpur Railway Station or Airport. Our representative will pick you up and drive towards the Sunauli border. After completing border formalities, proceed to Lumbini, the sacred birthplace of Lord Buddha. After exploring the Maya Devi Temple and Monastic zones, continue your scenic drive to Pokhara. Check-in to your hotel and relax. Overnight stay in Pokhara."
//     },
//     {
//       day: 2,
//       title: "Pokhara Local Sightseeing & Boating",
//       image: pokhara,
//       description: "After a delicious breakfast, head out for a full-day sightseeing tour of Pokhara. Visit the beautiful Davis Fall, explore the mysterious Gupteshwor Mahadev Cave, and seek blessings at the historic Bindabasini Temple. In the late afternoon, enjoy a peaceful boat ride on Phewa Lake and visit the Tal Barahi Temple situated in the middle of the lake. Overnight stay in Pokhara."
//     },
//     {
//       day: 3,
//       title: "Sarangkot Sunrise & Leisure Day",
//       image: sarangkot,
//       description: "Wake up early and drive to Sarangkot hill to witness a breathtaking sunrise over the majestic Annapurna and Dhaulagiri mountain ranges. Return to the hotel for breakfast. The rest of the day is free for leisure. You can explore the vibrant Lakeside market, relax at cafes, or opt for thrilling adventure activities like Paragliding or Bungee Jumping (at an extra cost). Overnight stay in Pokhara."
//     },
//     {
//       day: 4,
//       title: "Drive Back to Gorakhpur & Departure",
//       image: gorakhpur,
//       description: "After breakfast, check out from your hotel and begin your return journey towards the Indian border. Cross the Sunauli border and proceed straight to Gorakhpur. You will be dropped off at Gorakhpur Railway Station or Airport for your onward journey, carrying beautiful memories of Nepal."
//     }
//   ],
//   highlights: [
//     "Convenient pick-up and drop-off directly from Gorakhpur Station/Airport.",
//     "Visit the sacred birthplace of Lord Buddha in Lumbini.",
//     "Spectacular sunrise views over the Himalayas from Sarangkot.",
//     "Relaxing boat ride on the famous Phewa Lake in Pokhara.",
//     "Read More"
//   ],
//   transfer: [
...
//   ],
//   sightseeing: [
//     "Lumbini: Maya Devi Temple, Ashoka Pillar, Monastic Zones.",
//     "Pokhara: Phewa Lake Boating, Davis Fall, Gupteshwor Cave, Bindabasini Temple.",
//     "Sarangkot: Early morning Himalayan sunrise viewpoint."
//   ],
//   accommodation: [
//     "Pokhara: 3 Nights in a 3-star or 4-star category premium lake-view hotel."
//   ],
//   meals: [
...
//       "Any meals other than breakfast (Lunch/Dinner).",
//       "Monument entrance fees, boating charges, and camera fees.",
//       "Optional adventure sports (Paragliding, Bungee, Zip-line, etc.).",
...
//         <img src={packageData.topBannerImage} alt="Gorakhpur to Pokhara Banner" className="w-full h-full object-cover" />
...
//                 <Users size={14} className="mr-1" /> Road Trip
//               </div>
//               <div className="w-full md:w-2/3 h-full overflow-hidden">
//                 <img src={packageData.images[0]} alt="Sarangkot" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
//               </div>
//               <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
//                 <div className="flex-1 overflow-hidden">
//                   <img src={packageData.images[1]} alt="Lumbini" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
//                 </div>
...
//                   <span><strong className="text-gray-800 text-sm">Earn +550</strong><br/>Holiday Reward points on this booking</span>
...
//                   <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> GORAKH10</div>
//                   <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Gorakhpur departure tours*</p>
//                 </div>
//                 <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
...
// export default GorakhpurToPokhara;
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="w-full lg:w-[68%]">
            ...
            {/* --- TAB CONTENT: CALCULATE PRICE --- */} 
            {activeMainTab === 'calculate price' && (
              <div id="calculate-price-section" className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 animate-fadeIn">
                <h2 className="text-[22px] font-medium text-gray-800 mb-8">Calculate Price</h2> 
          ...
          <div className="w-full lg:w-[32%] sticky top-28 space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center">
              ...
              <button 
                ...
                className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3.5 rounded shadow-md transition-colors text-lg mb-4"
              >
                Book Now 
              </button>
