...
// --- GORAKHPUR TO LUMBINI MOCK DATA ---
const packageData = {
  title: "Spiritual Awakening: Gorakhpur to Lumbini Tour",
  rating: 4.8,
  reviews: 524,
  ...
  images: [
   lumbini, // Lumbini elements
    "https://images.unsplash.com/photo-1555881400-74d7acaacd8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", // Monastery
    "https://images.unsplash.com/photo-1544735716-392fe2489ffa?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"  // Peaceful nature
  ],
  itinerary: [
    {
      day: 1,
      title: "Pickup from Gorakhpur & Explore Maya Devi Temple",
      image: lumbini,
      description: "Arrive at Gorakhpur Railway Station or Airport in the morning. Our representative will pick you up and drive you to the Sunauli Indo-Nepal border. After quick border formalities, we head straight to Lumbini, the birthplace of Lord Buddha. Check into your hotel. In the afternoon, visit the sacred Maya Devi Temple, the exact birthplace of Buddha, the Ashoka Pillar, and the Holy Pond (Puskarni). Spend a peaceful evening meditating or walking around the sacred garden. Overnight stay in Lumbini."
    },
    {
      day: 2,
      title: "Monastic Zone, Peace Pagoda & Return to Gorakhpur",
      image: "https://images.unsplash.com/photo-1555881400-74d7acaacd8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "After a serene breakfast, explore the vast Lumbini Monastic Zone. You can hire a bicycle or take an eco-rickshaw to visit the World Peace Pagoda, the Royal Thai Monastery, the German Temple, and the Golden Temple of Myanmar. Each monastery features spectacular and unique global Buddhist architecture. In the afternoon, begin your drive back to the Sunauli border and further to Gorakhpur. You will be dropped off at Gorakhpur Railway Station/Airport for your onward journey."
    }
  ],
  highlights: [
    "Visit the exact birthplace of Lord Buddha at Maya Devi Temple.",
    "Explore the historic Ashoka Pillar erected in 249 BC.",
    "Tour the magnificent international monasteries and World Peace Pagoda.",
    "Seamless border crossing and private AC transport from Gorakhpur.",
    "Read More"
  ],
  transfer: [
  ...
  sightseeing: [
    ...
    "Lumbini: East and West Monastic Zones (Thai, German, Myanmar Monasteries).",
    "Lumbini Museum and Research Institute."
  ],
  accommodation: [
    "Lumbini: 1 Night in a 3-star or 4-star category premium peaceful hotel."
  ],
  meals: [
    "1 Buffet Breakfast at the hotel in Lumbini.",
  ...
  inclusionExclusions: {
    ...
    exclusions: [
      ...
      "E-rickshaw or bicycle rental charges inside the Monastic Zone.",
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] min-h-screen pb-20">
      ...
      <div className="w-full h-[250px] md:h-[350px] lg:h-[400px] mb-6 relative">
        <img src={packageData.topBannerImage} alt="Gorakhpur to Lumbini Banner" className="w-full h-full object-cover" />
          ...
          <div className="w-full lg:w-[68%]">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-[300px] md:h-[400px] mb-6 relative rounded-lg overflow-hidden">
              ...
              <div className="w-full md:w-2/3 h-full overflow-hidden">
                <img src={packageData.images[0]} alt="Maya Devi Temple" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="hidden md:flex flex-col gap-2 w-full md:w-1/3 h-full">
                ...
                <div className="flex-1 overflow-hidden relative cursor-pointer group">
                  <img src={packageData.images[2]} alt="Peace Pagoda" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  ...
                  <p className="text-[11px] text-gray-500 ml-6">Get 10% off on Lumbini Sightseeing*</p>
                </div>
                <div className="border border-dashed border-gray-300 rounded bg-[#fcfcfc] p-3 opacity-60">
                  <div className="flex items-center text-sm font-semibold text-gray-600 mb-1"><input type="radio" disabled className="mr-2" /> BUDDHA26</div>
                  <p className="text-[11px] text-gray-500 ml-6">Upto ₹3000 off on Credit Cards*</p>
                </div>
              </div>
            </div>
...
export default GorakhpurToLumbini;